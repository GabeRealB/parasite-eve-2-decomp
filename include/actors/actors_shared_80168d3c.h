...
/// `field_412` the per-state frame counter, `field_422` the sub-state index
/// the handler table walks, and `field_414` .. `field_426` the animation
