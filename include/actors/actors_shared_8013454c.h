...
/// The part of the carrier's work block this body touches: the saved previous
/// position at 0x274 and the per-frame step length at 0x2BE. Each carrier's
/// block is its own, larger type; the shared unit only names these fields.
