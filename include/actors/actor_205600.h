#ifndef ACTOR_205600_H
#define ACTOR_205600_H
...
typedef struct Actor205600FxWork {
...
typedef struct Actor205600PlaceSrc {
    /* 0x00 */ GpU16Pair pair;
    /* 0x04 */ u16       field_4;
    /* 0x06 */ u16       field_6;
    /* 0x08 */ u16       field_8;
...
STATIC_ASSERT_SIZEOF(Actor205600PlaceSrc, 0x14);

/// 0x38-byte scratch carved off `G_SCRATCH_HEAD` by
/// `func_actor_205600_8014CFD0`. `rot` first holds the local offset the root
...
typedef struct Actor205600PlaceScratch {
    /* 0x00 */ SVECTOR rot;
    /* 0x08 */ VECTOR  pos;
    /* 0x18 */ MATRIX  mtx;
} Actor205600PlaceScratch;
STATIC_ASSERT_SIZEOF(Actor205600PlaceScratch, 0x38);

/// Spawn/context block behind `Task::spawnArg2`; `field_8` is the halfword the
/// sound id takes its room/channel bits from.
typedef struct Actor205600Ctx {
    /* 0x00 */ byte pad_0[8];
    /* 0x08 */ u16  field_8;
} Actor205600Ctx;

/// Placement descriptor for this actor.
extern Actor205600PlaceSrc D_actor_205600_8015FFDC;

/// Sound id of the burst cue, with the spawn context's room/channel bits packed
/// in.
extern s32 D_actor_205600_80160110;
