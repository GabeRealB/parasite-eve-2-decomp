...
/// 0x20 scratch block the security room's coordinate walk takes from
...
STATIC_ASSERT_SIZEOF(AsrWalkScratch, 0x20);

/// 0xE4 scratch block `func_acropolis_security_room_80181E28` takes from
...
typedef struct AsrSightScratch {
    /* 0x00 */ MATRIX  m;
...
STATIC_ASSERT_SIZEOF(AsrSightScratch, 0xE4);
