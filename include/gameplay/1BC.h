...
/// `func_800B32E8` / `func_800B3910` / `func_800B46A4` / `func_800B4114` /
/// `func_800B4538` / `func_800B47A8` set bit 0/1 while walking `field_3`
/// links). `func_800B3910` / `func_800B4114` / `func_800B4538` /
/// `func_800B47A8` also clear `field_17` and write a `<< 4` value into
/// `field_C` / `field_E` (`func_800B3910` then overwrites both from
/// `recs[field_6].field_2`). `func_800B47A8` installs a
