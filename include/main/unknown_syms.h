...
/// MIDI status-byte handler used by func_80051BB0 / D_800689C4.
typedef u8* (*MidiHandler)(s32, u8*, GStruct36*, GStruct36Entry*);
/// MIDI status-byte dispatch table for func_80051BB0 (0x80..0xF0 → index 0..7).
...
extern s32        func_80055078(GStruct54* arg0);
...
extern void func_80057FAC(GStruct76* arg0);
