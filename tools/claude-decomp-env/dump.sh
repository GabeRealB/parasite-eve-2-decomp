...
echo "  load in .greg, copy in .sched2  post-reload CSE (reload1.c); trace_gcc.py --uids UID"
...
echo "For actual quantity membership and reload decisions: tools/trace_gcc.py (from root; CODEGEN_MODEL.md §12)."
