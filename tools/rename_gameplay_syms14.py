#!/usr/bin/env python3
"""
Fourteenth gameplay-overlay naming pass (Gp_).

Last unique leftover UI strings (status/PE/demo/help).

Run from repo root after rename_gameplay_syms13.py.
"""
...
RENAMES: list[tuple[str, str]] = [
    ("D_8009717C", "Gp_StrStatus"),
    ("D_80097194", "Gp_StrInvoke"),
    ("D_8009719C", "Gp_StrPeList"),
    ("D_800971A8", "Gp_StrTotal"),
    ("D_800971B0", "Gp_StrMessage"),
    ("D_800971B8", "Gp_StrWarning"),
    ("D_800971E8", "Gp_StrMap"),
    ("D_80097200", "Gp_StrNextLevel"),
    ("D_80097210", "Gp_StrCost"),
    ("D_80097218", "Gp_StrBonus"),
    ("D_80097544", "Gp_StrDemoWait"),
    ("D_80097550", "Gp_StrDemoPause"),
    ("D_8010F930", "Gp_StrUseAttachHelp"),
    ("D_8010F948", "Gp_StrUseKeyHelp"),
    ("D_8010F958", "Gp_StrCheckMap"),
    ("D_8010F96C", "Gp_StrCustomizeHelp"),
    ("D_8010F988", "Gp_StrRemoveAmmoHelp"),
    ("D_8010F9A4", "Gp_StrDetachArmorHelp"),
]
...
def main() -> int:
    ...
    if extra:
        if not gp.endswith("\n"):
            gp += "\n"
        gp += (
            "\n// Gameplay naming pass 14 (status/PE/demo/help strings)\n"
            + "\n".join(extra) + "\n"
        )
