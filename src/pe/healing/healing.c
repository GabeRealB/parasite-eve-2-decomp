...
/// Healing spark billboard. State 0 seeds the spin and colour from the spawn
/// argument and the LCG; state 1 lifts the frame and draws the additive quad
/// on odd ticks until the animation runs out. Life Drain carries an identical
/// copy, which is never called there.
