    ...
    switch (actor->field_95E) {
        ...
        case 2:
            ...
            Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8,
                          ((Player_Status.field_22 - 0xD) << 0x18) | 0x200E0005, 1);
            Gp_SpawnEff(0x600A1,
                        (GsCOORDINATE2*)((TmdObject*)actor->field_91C->extra)->field_8,
                        (Player_Status.field_22 << 0x10) | 0xE, NULL);
                ...
                if (Player_Status.field_22 == 0xE) {
                    if (hit != 0 || Gp_CountRec18Hi(actor->field_32C, 0x30000) != 0) {
                        ...
                        Gp_PlayObjSfx((GpObj38*)spot,
                                      ((Player_Status.field_22 - 0xD) << 0x18) | 0x200E0004, 1);
                    }
                } else if (hit != 0) {
        ...
        case 4:
            if (--actor->field_934 == 0) {
                actor->field_95E++;
                Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8,
                              ((Player_Status.field_22 - 0xD) << 0x18) | 0x200E0002, 0);
            }
            /* fallthrough */
        case 5:
