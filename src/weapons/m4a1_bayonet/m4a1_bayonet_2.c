    ...
    switch (actor->field_95E) {
        ...
        case 2:
            ...
            if (actor->field_97F & 1) {
                ...
                actor->field_979  = 9;
                actor->field_93E  = 3;
                actor->field_124  = Player_Status.weaponSlotItem | 0x21A00;
        ...
        case 3:
            if (actor->field_93E != 0) {
                ...
                if (delay == 0) {
                    ...
                    Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8, 0x201A0004, 1);
                    Gp_SpawnEff(0x6006B,
        ...
        case 6:
            ...
            if (frames == 0) {
                if (actor->field_95E == 5) {
                    ...
                    actor->field_93E  = 0xA;
                    actor->field_12A |= 0xC000;
                    Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8, 0x201A0006, 0);
            ...
            if (Gp_CountRec18Hi(actor->field_32C, 0x30000) != 0) {
                Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8, 0x201A0005, 0);
            }
            break;
        case 7:
