    ...
    switch (actor->field_95E) {
        ...
        case 2:
            ...
            Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8,
                          ((Wip_SysConfig.field_22 - 0xD) << 0x18) | 0x200D0005, 1);
            Gp_SpawnEff(0x600A1,
                        (GsCOORDINATE2*)((TmdObject*)actor->field_91C->extra)->field_8,
                        (Wip_SysConfig.field_22 << 0x10) | 0xD, NULL);
                ...
                if (Wip_SysConfig.field_22 == 0xE) {
                    if (hit != 0 || Gp_CountRec18Hi(actor->field_32C, 0x30000) != 0) {
                        ...
                        Gp_PlayObjSfx((GpObj38*)spot,
                                      ((Wip_SysConfig.field_22 - 0xD) << 0x18) | 0x200D0004, 1);
                    }
                } else if (hit != 0) {
        ...
        case 4:
            if (--actor->field_934 == 0) {
                actor->field_95E++;
                Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8,
                              ((Wip_SysConfig.field_22 - 0xD) << 0x18) | 0x200D0002, 0);
            }
            /* fallthrough */
        case 5:
