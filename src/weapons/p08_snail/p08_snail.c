...
void func_p08_snail_8011D1D8(GpActorWork* arg0)
{
    GameActor*     actor;
    GsCOORDINATE2* coord;
    GsCOORDINATE2* spot;
    ...
    switch (actor->field_95E) {
        ...
        case 2:
            ...
            Gp_PlayObjSfx((GpObj38*)arg0->extra->field_8, 0x20010004, 1);
            Gp_SpawnEff(0x6002B,
                        (GsCOORDINATE2*)((TmdObject*)actor->field_91C->extra)->field_8, 1, NULL);
