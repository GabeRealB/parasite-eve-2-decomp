...
void func_mp5a5_p1_8011D468(GsCOORDINATE2* arg0, s16 arg1, s16 arg2);
void func_mp5a5_p1_8011D864(GsCOORDINATE2* arg0, s16 arg1, s16 arg2);

extern s32 Gp_LcgState;

/// Muzzle offset of the MP5A5(+1), in the firing hand's coordinate frame.
SVECTOR D_mp5a5_p1_8011E128 = { 0, 0x240, 0x40, 0 };

/// Per-frame muzzle-flash task for the MP5A5(+1). Frame 0 claims room-coord slot 0
...
/// the core (`func_mp5a5_p1_8011D468`), a full-screen fade at the current
...
void func_mp5a5_p1_8011D1E0(Task* task)
{
    GpEffWork*     work;
    GsCOORDINATE2* coord;
    GpCoord64*     base;
    ...
    switch (task->state) {
        case 0:
            ...
            coord->coord.t[0] = D_mp5a5_p1_8011E128.vx;
            coord->coord.t[1] = D_mp5a5_p1_8011E128.vy;
            coord->coord.t[2] = D_mp5a5_p1_8011E128.vz;
            coord->flg        = 0;
            ...
            for (i = 0; i < 4; i++) {
                Gp_LcgState            = Gp_LcgState * 5 + 0x71357911;
                D_mp5a5_p1_8012B508[i] = ((i & 3) << 10) + (((u32)Gp_LcgState >> 16) & 0x3FF);
            }
            break;
        case 1:
    ...
    func_mp5a5_p1_8011D468(coord, work->scale, work->angle);
    ...
    for (i = 0; i < 4; i++) {
        func_mp5a5_p1_8011D864(coord, D_mp5a5_p1_8012B508[i], work->period);
    }
        ...
        case 3:
            if (--actor->field_934 == 0) {
                ...
                if (actor->field_97F == 1) {
                    ...
                    actor->field_934  = 3;
                    actor->field_940  = 0;
                    actor->field_124  = Player_Status.weaponSlotItem | 0x21F00;
