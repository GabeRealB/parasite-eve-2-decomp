...
void func_mp5a5_p1_8011D468(GsCOORDINATE2* coord, s16 arg1, s16 arg2);
...
void func_mp5a5_p1_8011D1E0(Task* task)
{
    ...
    func_mp5a5_p1_8011D468(coord, work->field_24, work->field_26);
    ...
    for (i = 0; i < 4; i++) {
        WeaponsShared8011d864(coord, D_mp5a5_p1_8012B508[i], work->field_28);
    }
...
INCLUDE_ASM("weapons/nonmatchings/mp5a5_p1/mp5a5_p1", func_mp5a5_p1_8011D468);

INCLUDE_RODATA("weapons/nonmatchings/mp5a5_p1/mp5a5_p1", D_mp5a5_p1_8011D1C0);
