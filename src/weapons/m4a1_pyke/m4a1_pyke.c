...
INCLUDE_RODATA("weapons/nonmatchings/m4a1_pyke/m4a1_pyke", D_m4a1_pyke_8011D1C0);

INCLUDE_ASM("weapons/nonmatchings/m4a1_pyke/m4a1_pyke", func_m4a1_pyke_8011D1F8);
