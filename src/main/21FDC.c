...
INCLUDE_ASM("main/nonmatchings/21FDC", func_80034070);
...
INCLUDE_ASM("main/nonmatchings/21FDC", func_80034B38);
...
INCLUDE_ASM("main/nonmatchings/21FDC", func_8003591C);

INCLUDE_ASM("main/nonmatchings/21FDC", func_80035960);
