...
} _ShelterB4WaterSupplyLight;

extern s32                        D_80070F70;
extern s16                        D_80071076;
extern s32                        D_8007107C;
extern s8                         D_8007217B;
extern _ShelterB4WaterSupplyLight D_80114FF8;
...
/// argument selects.
extern RoomsShared8017e4f8Shade D_shelter_b4_water_supply_801826F0[];
...
void func_shelter_b4_water_supply_8017F24C(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        func_shelter_b4_water_supply_8017F3A0(coord, (s16)work->field_26, (s16)work->field_24);
...
void func_shelter_b4_water_supply_8017F6D4(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        if (Gp_State1C->eventState < 4) {
            if (task->state < 2) {
                func_shelter_b4_water_supply_8017FB90(coord, (s16)work->field_20, (s16)work->field_24, (s16)work->field_26);
            } else {
                func_shelter_b4_water_supply_8017FF7C(coord, (s16)work->field_20, (s16)work->field_24);
            }
            return;
        }
        Gp_ReleaseState1CMem(work, task);
    ...
    if (Gp_State1C->eventState == 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(coord);
                if (work->field_22 & 1) {
                    func_shelter_b4_water_supply_80181158(coord, (s16)++work->field_20, 0x200, 0x80);
                }
