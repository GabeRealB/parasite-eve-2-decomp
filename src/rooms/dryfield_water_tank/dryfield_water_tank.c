...
INCLUDE_RODATA("rooms/nonmatchings/dryfield_water_tank/dryfield_water_tank", jtbl_dryfield_water_tank_8017D5D0);

INCLUDE_RODATA("rooms/nonmatchings/dryfield_water_tank/dryfield_water_tank", jtbl_dryfield_water_tank_8017D5E8);

INCLUDE_RODATA("rooms/nonmatchings/dryfield_water_tank/dryfield_water_tank", jtbl_dryfield_water_tank_8017D600);
