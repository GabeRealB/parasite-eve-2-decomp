...
INCLUDE_ASM("rooms/nonmatchings/acropolis_bridge/acropolis_bridge_11", func_acropolis_bridge_80185104);
...
INCLUDE_ASM("rooms/nonmatchings/acropolis_bridge/acropolis_bridge_11", func_acropolis_bridge_80186BBC);
