...
INCLUDE_RODATA("rooms/nonmatchings/acropolis_bridge/acropolis_bridge_11", D_acropolis_bridge_8017D6CC);

INCLUDE_RODATA("rooms/nonmatchings/acropolis_bridge/acropolis_bridge_11", D_acropolis_bridge_8017D6E8);
