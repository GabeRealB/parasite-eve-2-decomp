...
typedef struct {
    ...
    /* 0x14 */ s16 field_14;
    /* 0x16 */ s16 field_16;
} DryfieldNightTrailerCoachCapScript;
STATIC_ASSERT_SIZEOF(DryfieldNightTrailerCoachCapScript, 0x18);
...
void func_dryfield_night_trailer_coach_80181DB0(Task* task)
{
    ...
    s32                                 key;
    s32                                 one;
    DryfieldNightTrailerCoachCapScript* script;
    McSaveData*                         save;
    ...
    switch (task->state) {
        ...
        case 3:
            ...
            break;
        case 4:
            D_dryfield_night_trailer_coach_8018C218 = Task_SpawnFromTable(
                &D_dryfield_night_trailer_coach_80184FE4, 1, 0, script->field_10);
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                Task_Kill(D_dryfield_night_trailer_coach_8018C218);
                task->state++;
            } else if (Task_PollKill(D_dryfield_night_trailer_coach_8018C218, &poll) != 0) {
                task->state++;
            }
            break;
        case 6:
