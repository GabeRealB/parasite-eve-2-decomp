...
/// `func_dryfield_night_trailer_coach_8018138C` draws.
extern const char D_dryfield_night_trailer_coach_8017D75C[];
extern const char D_dryfield_night_trailer_coach_8017D768[];
