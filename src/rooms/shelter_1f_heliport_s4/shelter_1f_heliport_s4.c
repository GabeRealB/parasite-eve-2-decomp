...
s32 func_shelter_1f_heliport_s4_8017D5D0(void)
{
    return 0;
}
...
void func_shelter_1f_heliport_s4_8017D670(Task* task)
{
}

/// The event task's three states: install the message table, idle, and kill.
const TaskFuncTable3 D_shelter_1f_heliport_s4_8017D5C4 = {
    {
