...
{
    if ((in->field_2 == 1) && (gGameSession->field_5 == 2) && (GameFlag_GetNibble(0xCA) == 0)) {
...
void func_acropolis_observatory_8017D834(Task* task)
{
    ...
    if ((gGameSession->field_5 == 2) && (GameFlag_GetNibble(0xCA) == 0)) {
        D_8011540A = 1;
    }
...
{
    if ((D_acropolis_observatory_8017E7D8 == 0) && (gGameSession->field_8 == 3)) {
        D_acropolis_observatory_8017E7D8 = 1;
        Task_SpawnFromTable(&D_acropolis_observatory_8017E7DC, 1, 0, 0);
    }
    if ((D_acropolis_observatory_8017E7D8 == 0) && (gGameSession->field_8 == 4)) {
        D_acropolis_observatory_8017E7D8 = 1;
