...
} _ShelterB1SouthMaintenanceWalkwayLight;

extern s32                                    D_80070F70;
extern s16                                    D_80071076;
extern _ShelterB1SouthMaintenanceWalkwayLight D_80114FF8;
...
/// argument.
extern RoomsShared8017e4f8Shade D_shelter_b1_south_maintenance_walkway_801823E8[];
...
void func_shelter_b1_south_maintenance_walkway_8017D5F8(Task* arg0)
{
    switch (arg0->state) {
        case 0:
            ...
            Gp_RunCapCmd(D_shelter_b1_south_maintenance_walkway_80183648.field_0, 0);
            D_80115690 = 1;
            arg0->state++;
            break;
        case 1:
            if (Gp_CapBusy() == 0) {
                if (D_shelter_b1_south_maintenance_walkway_80183648.field_A != 0) {
            ...
            break;
        case 2:
            if (D_shelter_b1_south_maintenance_walkway_80183648.field_4 != 0) {
                Gp_EnqueueStageSnd6(D_shelter_b1_south_maintenance_walkway_80183648.field_4, 0, 0);
                arg0->state++;
            } else {
                arg0->state = 4;
            }
            break;
        case 3:
            if (SndVoice_HasActiveId(Gp_PackStageSndId(D_shelter_b1_south_maintenance_walkway_80183648.field_4)) == 0) {
                arg0->state++;
            }
            break;
        case 4:
