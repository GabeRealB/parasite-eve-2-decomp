...
typedef struct {
    ...
    /* 0x14 */ s16 field_14;
    /* 0x16 */ s16 field_16;
} DryfieldNightMotelRoom6CapScript;

STATIC_ASSERT_SIZEOF(DryfieldNightMotelRoom6CapScript, 0x18);
...
void func_dryfield_night_motel_room_6_801811F0(Task* task)
{
    ...
    s32                               key;
    s32                               one;
    DryfieldNightMotelRoom6CapScript* script;
    McSaveData*                       save;
    ...
    switch (task->state) {
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                Task_Kill(D_dryfield_night_motel_room_6_801862B4);
                task->state++;
...
INCLUDE_RODATA("rooms/nonmatchings/dryfield_night_motel_room_6/dryfield_night_motel_room_6_2", RoomsShared8017d878Table);
