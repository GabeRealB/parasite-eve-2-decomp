...
s32 func_dryfield_motel_room_4_8017D5D0(void)
{
    return 0;
}
...
s32 func_dryfield_motel_room_4_8017D600(void)
{
    return 0;
}

/// Message-table handler for id 0x13EF: accepts the message and does nothing.
s32 func_dryfield_motel_room_4_8017D608(void)
{
    return 0;
}
...
void func_dryfield_motel_room_4_8017D610(Task* task)
{
...
void func_dryfield_motel_room_4_8017D654(Task* task)
{
}

/// The room task's three states.
const TaskFuncTable3 D_dryfield_motel_room_4_8017D5C4 = {
