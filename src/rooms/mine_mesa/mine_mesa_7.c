...
INCLUDE_RODATA("rooms/nonmatchings/mine_mesa/mine_mesa_7", jtbl_mine_mesa_8017D644);

INCLUDE_RODATA("rooms/nonmatchings/mine_mesa/mine_mesa_7", D_mine_mesa_8017D660);
