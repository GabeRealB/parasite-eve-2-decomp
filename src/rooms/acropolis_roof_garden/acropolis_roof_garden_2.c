...
s32 func_acropolis_roof_garden_8017D7A0(s32 arg0, s32 arg1, RoomEventMsg* in, RoomEventMsg* out)
{
    switch (in->field_2) {
        case 1:
            if (((gGameSession->field_9 == 1) || (gGameSession->field_9 == 7)) && (GameFlag_GetNibble(0xCB) == 0)) {
                GameFlag_SetNibble(0xCB, 1);
            }
            break;
        case 2:
            if (((gGameSession->field_9 == 1) || (gGameSession->field_9 == 7)) && (GameFlag_GetNibble(0xCB) == 1)) {
...
void func_acropolis_roof_garden_8017DBEC(void)
{
    ...
    if ((gGameSession->field_8 == 2) && (D_acropolis_roof_garden_8018432C == 0)) {
