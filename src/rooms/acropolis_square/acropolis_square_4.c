...
INCLUDE_RODATA("rooms/nonmatchings/acropolis_square/acropolis_square_4", RoomsShared8017d878Table);
...
INCLUDE_ASM("rooms/nonmatchings/acropolis_square/acropolis_square_4", func_acropolis_square_80182048);
