...
INCLUDE_ASM("rooms/nonmatchings/acropolis_square/acropolis_square_7", func_acropolis_square_80182260);
...
INCLUDE_ASM("rooms/nonmatchings/acropolis_square/acropolis_square_7", func_acropolis_square_80182308);
