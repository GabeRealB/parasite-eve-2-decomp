...
INCLUDE_ASM("rooms/nonmatchings/dryfield_gas_station/dryfield_gas_station_2", func_dryfield_gas_station_8017F13C);
...
INCLUDE_ASM("rooms/nonmatchings/dryfield_gas_station/dryfield_gas_station_2", func_dryfield_gas_station_8017F3B0);
