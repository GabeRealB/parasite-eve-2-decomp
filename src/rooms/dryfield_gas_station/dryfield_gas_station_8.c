...
extern const char D_dryfield_gas_station_8017D624[];
extern const char D_dryfield_gas_station_8017D630[];

/// Title of the "Telephone" menu.
...
/// UI descriptor of the help-line box the usage panel opens beside its list.
