...
void func_dryfield_night_garage_8017FF2C(Task* task)
{
    ...
    if (gGameSession->loc.place == 3 && player != NULL) {
    ...
    if (gGameSession->loc.place == 2 && GameFlag_GetNibble(0x6C) > 0) {
...
s32 func_dryfield_night_garage_801800C8(Task* task, s32 msgId, GpMsg13EF* msg, s32 arg3)
{
    ...
    if (msg->field_2 == 2 && gGameSession->loc.place == 3 && Game_GetPtrSlot(0xA) != NULL) {
