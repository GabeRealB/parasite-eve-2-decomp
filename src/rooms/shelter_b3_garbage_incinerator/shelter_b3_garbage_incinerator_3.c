...
void func_shelter_b3_garbage_incinerator_80182368(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        if (task->spawnArg1 < 0) {
            func_shelter_b3_garbage_incinerator_80182F18(coord, work->field_20 | work->field_18, (s16)work->field_24, (s16)work->field_26);
        } else {
            func_shelter_b3_garbage_incinerator_80182AB8(coord, work->field_20 | work->field_18, (s16)work->field_24, (s16)work->field_26);
        }
