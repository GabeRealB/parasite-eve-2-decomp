...
/// and `[1]` the second trail's frame. `D_neo_ark_power_plant_2_80180688` is
...
void func_neo_ark_power_plant_2_8017E098(GsCOORDINATE2* arg0, s32 arg1, s32 arg2, u8* rgb);
void func_neo_ark_power_plant_2_8017E4C4(GsCOORDINATE2* arg0, s32 arg1, u8* rgb);
void func_neo_ark_power_plant_2_8017ED48(GsCOORDINATE2* arg0, GsCOORDINATE2* arg1, s16 arg2, s16 arg3);
void func_neo_ark_power_plant_2_8017F3C8(GsCOORDINATE2* arg0, s16 arg1, u8* arg2);
...
s32 func_neo_ark_power_plant_2_8017D5D0(void)
{
    return 0;
}
...
s32 func_neo_ark_power_plant_2_8017D694(void)
{
    return 0;
}
    ...
    if (Gp_State1C->eventState < 2) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(objCoord);
                coord.sub        = work->parent;
                coord.coord.t[0] = D_neo_ark_power_plant_2_80180688.vx;
                coord.coord.t[1] = D_neo_ark_power_plant_2_80180688.vy;
                coord.coord.t[2] = D_neo_ark_power_plant_2_80180688.vz;
                coord.flg        = 0;
                Gp_UpdateCoord(&coord);
