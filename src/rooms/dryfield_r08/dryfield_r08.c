...
INCLUDE_RODATA("rooms/nonmatchings/dryfield_r08/dryfield_r08", D_dryfield_r08_8017D5C0);

INCLUDE_ASM("rooms/nonmatchings/dryfield_r08/dryfield_r08", func_dryfield_r08_8017D5F8);
