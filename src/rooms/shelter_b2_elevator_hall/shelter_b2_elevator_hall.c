    ...
    if (Gp_State1C->eventState != 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b2_elevator_hall_8017F4A4(coord, work->field_20, work->field_26 | 0x1000, work->field_24 | work->field_28);
                }
            ...
            case 2:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b2_elevator_hall_8017F4A4(coord, work->field_20, work->field_26, work->field_24 | work->field_28);
                }
                if ((s16)work->field_24 > 0) {
                    if ((s16)work->field_2A - 8 < (s16)work->field_22) {
                        work->field_24 -= 0x10;
