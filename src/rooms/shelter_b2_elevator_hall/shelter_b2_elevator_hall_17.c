...
extern void func_shelter_b2_elevator_hall_8017F768(GsCOORDINATE2* arg0, s16 arg1, s32 arg2, u8* arg3);
    ...
    if (flag != 0) {
        ...
        switch (arg0->state) {
            ...
            case 1:
                ...
                func_shelter_b2_elevator_hall_8017F768(coord, 0x300 - (u16)mem->angle * 2, 0x80, rgb);
                if (arg0->spawnArg1 == 0) {
                    mem->scale  = 0xFF;
                    arg0->state = 2;
                    return;
...
void func_shelter_b2_elevator_hall_801802B8(Task* arg0)
{
    ...
    if (flag != 0) {
        ...
        if (mem->period >= 0x19) {
            ...
            func_shelter_b2_elevator_hall_8017F768(coord, mem->step * 3 / 2, 0x60, rgb);
            mem->period -= 0x18;
            mem->step   += 0x30;
            return;
        }
