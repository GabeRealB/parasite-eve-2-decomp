...
/// `func_shelter_b2_elevator_hall_80180990` draws under it. Also
/// feeds the gameplay light slot a flickering intensity at the coordinate's
/// position. Draws nothing when the point fails to project.
