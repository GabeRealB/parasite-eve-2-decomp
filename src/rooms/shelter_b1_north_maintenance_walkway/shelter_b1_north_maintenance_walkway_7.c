...
/// argument.
extern s16 D_shelter_b1_north_maintenance_walkway_80184B74[][3];
...
void func_shelter_b1_north_maintenance_walkway_80182E70(Task* arg0)
{
    ...
    switch (arg0->state) {
        ...
        case 1:
            ...
            col[0] = mem->scale >> D_shelter_b1_north_maintenance_walkway_80184B74[arg0->spawnArg1][0];
            col[1] = mem->scale >> D_shelter_b1_north_maintenance_walkway_80184B74[arg0->spawnArg1][1];
            col[2] = mem->scale >> D_shelter_b1_north_maintenance_walkway_80184B74[arg0->spawnArg1][2];
