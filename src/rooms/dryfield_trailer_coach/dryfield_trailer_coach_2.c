...
void func_dryfield_trailer_coach_80181D88(Task* task)
{
    ...
    s32                            key;
    s32                            one;
    DryfieldTrailerCoachCapScript* script;
    McSaveData*                    save;
    ...
    switch (task->state) {
        ...
        case 3:
            ...
            break;
        case 4:
            D_dryfield_trailer_coach_80189C94 = Task_SpawnFromTable(
                &D_dryfield_trailer_coach_80184F7C, 1, 0, script->field_10);
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                Task_Kill(D_dryfield_trailer_coach_80189C94);
                task->state++;
            } else if (Task_PollKill(D_dryfield_trailer_coach_80189C94, &poll) != 0) {
                task->state++;
            }
            break;
        case 6:
...
INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182578);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182580);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801825A8);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801826A0);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182794);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801827D0);

INCLUDE_RODATA("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", D_dryfield_trailer_coach_8017D7DC);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801827F8);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182850);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182888);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_8018291C);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182950);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801829A8);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_80182EB4);

INCLUDE_ASM("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_801838DC);

INCLUDE_RODATA("rooms/nonmatchings/dryfield_trailer_coach/dryfield_trailer_coach_2", func_dryfield_trailer_coach_8017D7F4);
