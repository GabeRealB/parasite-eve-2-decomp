...
STATIC_ASSERT_SIZEOF(ShelterR47CapScript, 0x18);
...
void func_shelter_r47_8017F628(Task* task)
{
    ...
    switch (task->state) {
        ...
        case 3:
            ...
            break;
        case 4:
            D_shelter_r47_8018A68C =
                Task_SpawnFromTable(&D_shelter_r47_80186F08, 1, 0, script->field_10);
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                Task_Kill(D_shelter_r47_8018A68C);
                task->state++;
            } else if (Task_PollKill(D_shelter_r47_8018A68C, &poll) != 0) {
                task->state++;
            }
            break;
        case 6:
