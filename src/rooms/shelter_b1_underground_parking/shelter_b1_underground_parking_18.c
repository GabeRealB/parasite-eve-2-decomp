...
/// Titles of the weapon and PE usage panels, and the list both fill.
extern const char D_shelter_b1_underground_parking_8017D624[];
extern const char D_shelter_b1_underground_parking_8017D630[];
extern UiList     D_shelter_b1_underground_parking_80186B10;

/// Title of the play-data menu, and its list.
...
/// PE twin of `func_shelter_b1_underground_parking_8017E618`: fills the "Play Data" PE-usage panel's
