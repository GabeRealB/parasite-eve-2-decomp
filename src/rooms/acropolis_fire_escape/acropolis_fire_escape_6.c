...
INCLUDE_ASM("rooms/nonmatchings/acropolis_fire_escape/acropolis_fire_escape_6", func_acropolis_fire_escape_80180154);

INCLUDE_ASM("rooms/nonmatchings/acropolis_fire_escape/acropolis_fire_escape_6", func_acropolis_fire_escape_80180B20);
