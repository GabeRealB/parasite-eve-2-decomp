...
INCLUDE_ASM("rooms/nonmatchings/acropolis_fire_escape/acropolis_fire_escape_4", func_acropolis_fire_escape_8017F9F8);
...
INCLUDE_ASM("rooms/nonmatchings/acropolis_fire_escape/acropolis_fire_escape_4", func_acropolis_fire_escape_8017FD08);
