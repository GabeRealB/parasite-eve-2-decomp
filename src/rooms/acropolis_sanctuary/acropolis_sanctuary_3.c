...
void func_acropolis_sanctuary_8017DF88(s32 arg0, s32 arg1)
{
    ...
    cmd = Gp_SprtTables[sess->stage - 1][g->field_74 - 1].field_0[sess->area - 1][(arg1 & 0xFF) - 1].field_4;
    if ((arg0 & 0xFF) == 0) {
        cmd[1].field_4 = 0;
        cmd[2].field_4 = 1;
    } else {
...
void func_acropolis_sanctuary_8017E338(Task* arg0)
{
    ...
    *(void**)G_SCRATCH_HEAD = (u8*)*(void**)G_SCRATCH_HEAD + 0x28;
    ...
    if ((u8)gGameSession->loc.view != 0x10 && D_acropolis_sanctuary_80182770 != 0 &&
...
void func_acropolis_sanctuary_8017F4E8(Task* arg0)
{
    ...
    mem   = arg0->spawnArg2;
    coord = ((TmdObject*)arg0->extra)->field_8;
    if ((D_acropolis_sanctuary_801827D4[arg0->spawnArg1 & 0xF] >> ((u8)gGameSession->loc.view - 1)) & 1) {
        Gp_UpdateCoord(coord);
        scratch  = (void**)G_SCRATCH_HEAD;
        head     = *scratch;
        *scratch = head - 0x14;
