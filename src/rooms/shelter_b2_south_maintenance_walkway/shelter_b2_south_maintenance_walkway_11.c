...
void func_shelter_b2_south_maintenance_walkway_8017EC40(GsCOORDINATE2* coord, s32 arg1, s32 arg2, u8* rgb);
void func_shelter_b2_south_maintenance_walkway_8017F06C(GsCOORDINATE2* coord, s32 arg1, u8* rgb);
void func_shelter_b2_south_maintenance_walkway_8017FF70(GsCOORDINATE2* coord, s16 arg1, u8* rgb);
    ...
    if (Gp_State1C->eventState != 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                func_shelter_b2_south_maintenance_walkway_8017F06C(coord, (s16)work->angle, rgb);
                rgb[0] >>= 1;
                rgb[1] >>= 1;
                rgb[2] >>= 1;
            ...
            case 2:
                if ((s16)work->scale >= 0x11) {
                    ...
                    rgb[1] = (u16)work->scale >> 2;
                    rgb[2] = (u16)work->scale >> 1;
                    func_shelter_b2_south_maintenance_walkway_8017FF70(coord, (s16)((s16)work->angle * 3), rgb);
                    work->scale -= 0x10;
                    work->angle -= 8;
                    break;
                }
