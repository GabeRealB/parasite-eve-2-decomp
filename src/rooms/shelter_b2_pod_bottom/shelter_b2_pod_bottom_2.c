...
/// GTE commands as this build emits them, each with its two leading hazard
/// nops; the `inline_c.h` macros of these names lack the nops or, for `rtv0`,
/// assemble to a different word.
