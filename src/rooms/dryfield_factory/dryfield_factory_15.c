...
/// A zero word the original `.rodata` carries after this unit's two jump
/// tables. Nothing is known to read it; defining it here keeps every later
/// rodata symbol at its address.
const u32 D_dryfield_factory_8017D6C4 = 0;
