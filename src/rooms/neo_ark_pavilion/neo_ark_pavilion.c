...
extern _NeoArkPavilionLight D_80114FF8;
...
void func_neo_ark_pavilion_8017D660(Task* task)
{
    ...
    s32                           area;
    POLY_FT4*                     prim;
    _NeoArkPavilionRippleScratch* scratch;
    s32                           y;
    s32                           y0;
    s32                           xl;
    s32                           xr;
    ...
    *(_NeoArkPavilionRippleScratch**)G_SCRATCH_HEAD = *(_NeoArkPavilionRippleScratch**)G_SCRATCH_HEAD - 1;
    scratch                                         = *(_NeoArkPavilionRippleScratch**)G_SCRATCH_HEAD;
    ...
    *(_NeoArkPavilionRippleScratch**)G_SCRATCH_HEAD += 1;
}
...
void func_neo_ark_pavilion_8017EC4C(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        func_neo_ark_pavilion_8017ED98(coord, (s16)work->field_26, (s16)work->field_24);
...
void func_neo_ark_pavilion_8017F0CC(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        if (task->state < 2) {
            func_neo_ark_pavilion_8017F588(coord, work->field_20, (s16)work->field_24, (s16)work->field_26);
        } else {
            func_neo_ark_pavilion_8017F974(coord, work->field_20, (s16)work->field_24);
        }
        if (Gp_State1C->eventState >= 4) {
            Gp_ReleaseState1CMem(work, task);
        }
    ...
    if (Gp_State1C->eventState != 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                func_neo_ark_pavilion_80180380(coord, (s16)work->angle, rgb);
                rgb[0] >>= 1;
                rgb[1] >>= 1;
                rgb[2] >>= 1;
            ...
            case 2:
                if ((s16)work->scale >= 0x11) {
                    ...
                    rgb[1] = (u16)work->scale >> 2;
                    rgb[2] = (u16)work->scale >> 1;
                    func_neo_ark_pavilion_80181284(coord, (s16)((s16)work->angle * 3), rgb);
                    work->scale -= 0x10;
                    work->angle -= 8;
                    break;
                }
    ...
    if (Gp_State1C->eventState == 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(coord);
                if (work->field_22 & 1) {
                    func_neo_ark_pavilion_801823C0(coord, (s16)++work->field_20, 0x200, 0x80);
                }
...
/// `func_neo_ark_pavilion_801834D4` on the ground beneath it. It also points the gameplay light slot at the
...
/// `Gfx_ViewWorldMtx` (no GTE translation) and adds `arg0->workm.t`, then
