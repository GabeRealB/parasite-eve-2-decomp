...
/// 0x7DB payload, picked by `gGameSession::loc.warp`. They are the last two of
...
///
/// On the visit whose sub-id (`gGameSession::loc.place`) is 1 and that has
...
/// `gGameSession::loc.warp` selects. On sub-id 0xA, with pointer slot 0xA
