...
INCLUDE_RODATA("rooms/nonmatchings/mist_parking/mist_parking_2", D_mist_parking_8017D6D8);
...
INCLUDE_ASM("rooms/nonmatchings/mist_parking/mist_parking_2", func_mist_parking_8017F764);
