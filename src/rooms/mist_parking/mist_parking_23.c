...
/// `func_mist_parking_801812B4` draws (item and PE), and the menu
/// `func_mist_parking_80181468` draws.
extern const char D_mist_parking_8017D75C[];
extern const char D_mist_parking_8017D768[];
