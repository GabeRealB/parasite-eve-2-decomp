...
INCLUDE_RODATA("rooms/nonmatchings/mist_parking/mist_parking_7", D_mist_parking_8017D7DC);

INCLUDE_RODATA("rooms/nonmatchings/mist_parking/mist_parking_7", D_mist_parking_8017D7F4);
