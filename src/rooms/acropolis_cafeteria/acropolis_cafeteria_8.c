...
INCLUDE_ASM("rooms/nonmatchings/acropolis_cafeteria/acropolis_cafeteria_8", func_acropolis_cafeteria_80182078);
...
INCLUDE_ASM("rooms/nonmatchings/acropolis_cafeteria/acropolis_cafeteria_8", func_acropolis_cafeteria_80182A08);
