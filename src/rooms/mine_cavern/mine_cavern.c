...
INCLUDE_ASM("rooms/nonmatchings/mine_cavern/mine_cavern", func_mine_cavern_8017DAA0);
...
INCLUDE_RODATA("rooms/nonmatchings/mine_cavern/mine_cavern", jtbl_mine_cavern_8017D5D0);
