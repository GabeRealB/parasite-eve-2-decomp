...
void func_neo_ark_bridge_8017D638(Task* task)
{
    ...
    s32                         area;
    POLY_FT4*                   prim;
    _NeoArkBridgeRippleScratch* scratch;
    s32                         y;
    s32                         y0;
    s32                         xl;
    s32                         xr;
    ...
    *(_NeoArkBridgeRippleScratch**)G_SCRATCH_HEAD = *(_NeoArkBridgeRippleScratch**)G_SCRATCH_HEAD - 1;
    scratch                                       = *(_NeoArkBridgeRippleScratch**)G_SCRATCH_HEAD;
    ...
    *(_NeoArkBridgeRippleScratch**)G_SCRATCH_HEAD += 1;
}
