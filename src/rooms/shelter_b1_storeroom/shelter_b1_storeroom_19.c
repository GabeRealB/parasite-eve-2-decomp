...
extern void func_shelter_b1_storeroom_80181070(GsCOORDINATE2* arg0, s16 arg1, s16 arg2, u8* arg3);
    ...
    if (flag != 0) {
        ...
        switch (arg0->state) {
            ...
            case 1:
                ...
                func_shelter_b1_storeroom_80181070(coord, 0x300 - (u16)mem->angle * 2, 0x80, rgb);
                if (arg0->spawnArg1 == 0) {
                    mem->scale  = 0xFF;
                    arg0->state = 2;
                    rgb[0]      = mem->scale;
