...
void func_neo_ark_island_8017D650(Task* task)
{
    ...
    s32                         area;
    POLY_FT4*                   prim;
    _NeoArkIslandRippleScratch* scratch;
    s32                         y;
    s32                         y0;
    s32                         xl;
    s32                         xr;
    ...
    *(_NeoArkIslandRippleScratch**)G_SCRATCH_HEAD = *(_NeoArkIslandRippleScratch**)G_SCRATCH_HEAD - 1;
    scratch                                       = *(_NeoArkIslandRippleScratch**)G_SCRATCH_HEAD;
    ...
    *(_NeoArkIslandRippleScratch**)G_SCRATCH_HEAD += 1;
}
