...
typedef struct {
    ...
    /* 0x14 */ s16 field_14;
    /* 0x16 */ s16 field_16;
} DryfieldMotelRoom6CapScript;

STATIC_ASSERT_SIZEOF(DryfieldMotelRoom6CapScript, 0x18);

extern TaskDesc D_dryfield_motel_room_6_80182D24;

/// Area-record patch list applied when the scene advances the story flags.
...
void func_dryfield_motel_room_6_801811D4(Task* task)
{
    ...
    s32                          key;
    s32                          one;
    DryfieldMotelRoom6CapScript* script;
    McSaveData*                  save;
...
INCLUDE_RODATA("rooms/nonmatchings/dryfield_motel_room_6/dryfield_motel_room_6_2", D_dryfield_motel_room_6_8017D6B4);
