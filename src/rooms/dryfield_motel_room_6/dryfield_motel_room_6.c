...
extern u8 D_dryfield_motel_room_6_801829E8[];
extern u8 D_dryfield_motel_room_6_801829F0[];
extern u8 D_dryfield_motel_room_6_801829FC[];
extern u8 D_dryfield_motel_room_6_80182A08[];

/// Row labels of the play-data statistics panel, one per row
/// `func_dryfield_motel_room_6_8017D6C0` draws.
extern u8 D_dryfield_motel_room_6_80182A10[];
extern u8 D_dryfield_motel_room_6_80182A40[];
extern u8 D_dryfield_motel_room_6_80182A18[];
extern u8 D_dryfield_motel_room_6_80182A1C[];
extern u8 D_dryfield_motel_room_6_80182A24[];
extern u8 D_dryfield_motel_room_6_80182A30[];
extern u8 D_dryfield_motel_room_6_80182A48[];
extern u8 D_dryfield_motel_room_6_80182A50[];
extern u8 D_dryfield_motel_room_6_80182A58[];

/// The suffix appended to that panel's count rows.
extern u8 D_dryfield_motel_room_6_80182A60[];
...
/// the selected row.
extern u8 D_dryfield_motel_room_6_80182A6C[];
extern u8 D_dryfield_motel_room_6_80182A98[];
extern u8 D_dryfield_motel_room_6_80182ABC[];
extern u8 D_dryfield_motel_room_6_80182AEC[];
extern u8 D_dryfield_motel_room_6_80182B20[];
extern u8 D_dryfield_motel_room_6_80182B54[];
extern u8 D_dryfield_motel_room_6_80182B8C[];
extern u8 D_dryfield_motel_room_6_80182BC0[];
extern u8 D_dryfield_motel_room_6_80182BF8[];

/// The play-data menu panel's list.
extern UiList D_dryfield_motel_room_6_80182C34;

/// The usage panel's list.
extern UiList D_dryfield_motel_room_6_80182C5C;
...
extern UiObjectDesc D_dryfield_motel_room_6_80182C9C;
extern UiObjectDesc D_dryfield_motel_room_6_80182CB8;

/// The telephone menu panel's list.
extern UiList D_dryfield_motel_room_6_80182CE4;
...
/// scene.
extern Task* D_dryfield_motel_room_6_8018682C;
...
void func_dryfield_motel_room_6_8017D6C0(DialogPrompt* arg0, UiObject* arg1)
{
    u8  buf[0x20];
    u8* p;
    ...
    if (((arg1->status >> 16) == 1) || (arg1->status == 1)) {
        if (arg0->field_10 == arg0->field_8) {
            u8* tbl[9] = {
                D_dryfield_motel_room_6_80182A6C,
                D_dryfield_motel_room_6_80182A98,
                D_dryfield_motel_room_6_80182ABC,
                D_dryfield_motel_room_6_80182AEC,
                D_dryfield_motel_room_6_80182B20,
                D_dryfield_motel_room_6_80182B54,
                D_dryfield_motel_room_6_80182B8C,
                D_dryfield_motel_room_6_80182BC0,
                D_dryfield_motel_room_6_80182BF8,
            };
    ...
    switch (arg0->field_8) {
        case 0: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A10);
        ...
        case 1: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A40);
            Text_ItoaUnsigned(p, Mc_SaveData.saveCount);
            Text_Strcat(p, D_dryfield_motel_room_6_80182A60);
            Text_DrawPrompt(arg1, -arg0->field_18, arg0->field_1A, buf, arg0->field_1C, 3, 2);
            break;
        }
        case 2: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A18);
        ...
        case 3: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A1C);
        ...
        case 4: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A24);
            ...
            q[1] = 0x2E;
            Text_Strcat(p, D_dryfield_motel_room_6_80182A68);
            Text_DrawPrompt(arg1, -arg0->field_18, arg0->field_1A, buf, arg0->field_1C, 3, 2);
            break;
        }
        case 5: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A30);
            cnt   = 326;
        ...
        case 6: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A48);
        ...
        case 7: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A50);
        ...
        case 8: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_dryfield_motel_room_6_80182A58);
...
void func_dryfield_motel_room_6_8017DE8C(DialogPrompt* arg0, UiObject* arg1)
{
    u8             buf[0x20];
    TextDrawReq    req;
    TextDrawReq*   r;
    ...
    limit = 1;
    if (value >= 10000) {
        Text_DrawPrompt(arg1, -arg0->field_18, arg0->field_1A, D_dryfield_motel_room_6_8017D61C, arg0->field_1C, 3, 2);
    } else {
        for (i = 2; i > 0; i--) {
            limit *= 10;
        }
...
/// Parasite Energy counterpart of `func_dryfield_motel_room_6_8017E288`:
...
void func_dryfield_motel_room_6_8017E8A4(Task* task)
{
    UiObject* obj;
    UiList*   list;
    Task*     child;
    ...
    obj           = task->spawnArg2;
    obj->field_2E = 0;
    list          = &D_dryfield_motel_room_6_80182C5C;
    if (task->spawnArg1 == 0) {
        Ui_DrawText((UiPanel*)obj, D_dryfield_motel_room_6_8017D624);
    } else {
        Ui_DrawText((UiPanel*)obj, D_dryfield_motel_room_6_8017D630);
    }
    if (task->state == 0) {
        ...
        task->work = work;
        Ui_SpawnFromDesc(&D_dryfield_motel_room_6_80182C80, 0, 0, 1, obj);
        if (task->spawnArg1 == 0) {
            func_dryfield_motel_room_6_8017E288(list, obj);
        } else {
            func_dryfield_motel_room_6_8017E584(list, obj);
        }
...
INCLUDE_RODATA("rooms/nonmatchings/dryfield_motel_room_6/dryfield_motel_room_6", D_dryfield_motel_room_6_8017D638);
...
void func_dryfield_motel_room_6_8017EA58(Task* task)
{
    ...
    list          = &D_dryfield_motel_room_6_80182CE4;
    one           = 1;
    ...
    if (ready == 0) {
        ...
        Ui_DrawText((UiPanel*)obj, D_dryfield_motel_room_6_8017D638);
        Ui_UpdateListNoAnim(list, obj);
    }
    if (obj->field_2E == 6) {
        obj->field_2E = 0;
...
/// lines.
void func_dryfield_motel_room_6_8017ED50(Task* task)
{
    UiObject* obj;
    ...
    if (task->state == 0) {
        ...
        task->exitCallback = func_dryfield_motel_room_6_8017F440;
        task->state       += 1;
    }
...
u8* func_dryfield_motel_room_6_8017EE1C(u8* buf, s32 value, s32 decimals)
{
    ...
    Text_Strcat(buf, D_dryfield_motel_room_6_80182A68);
    return buf;
}
...
void func_dryfield_motel_room_6_8017EF10(Task* task)
{
    UiObject* obj;
    UiList*   list;

    list          = &D_dryfield_motel_room_6_80182C34;
    obj           = task->spawnArg2;
    obj->field_2E = 0;
    Ui_DrawText((UiPanel*)obj, D_dryfield_motel_room_6_8017D610);
    if (task->state == 0) {
        Ui_SpawnFromDesc(&D_dryfield_motel_room_6_80182C80, 0, 0, 1, obj);
        Ui_LayoutListPanel(list, (UiPanel*)obj);
        obj->field_12 += 5;
...
void func_dryfield_motel_room_6_8017F104(DialogPrompt* prompt, UiObject* obj)
{
    s32 sel;

    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_dryfield_motel_room_6_801829E8, prompt->field_1C, 1, 0);
    sel = prompt->field_C;
...
void func_dryfield_motel_room_6_8017F1E8(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_dryfield_motel_room_6_801829F0, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_dryfield_motel_room_6_80182C9C, 0, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
...
void func_dryfield_motel_room_6_8017F2B0(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_dryfield_motel_room_6_801829FC, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_dryfield_motel_room_6_80182CB8, 0, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
...
void func_dryfield_motel_room_6_8017F378(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_dryfield_motel_room_6_80182A08, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_dryfield_motel_room_6_80182CB8, 1, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
...
void func_dryfield_motel_room_6_8017F47C(Task* task)
{
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (child != NULL) {
            spawned = Task_SpawnFromTable(&D_dryfield_motel_room_6_80182D0C, 1, i, (s32)task);
            if (spawned != NULL) {
...
void func_dryfield_motel_room_6_8017F630(Task* task)
{
    ...
    if (work->configRev != status->weapon) {
        ...
        for (i = 0; i < 2; i++) {
            ...
            if (child != NULL) {
                spawned = Task_SpawnFromTable(&D_dryfield_motel_room_6_80182D0C, 1, i + 2, (s32)task);
                if (spawned != NULL) {
                    Task_Reparent(child, spawned);
                }
            }
...
void func_dryfield_motel_room_6_80180FB4(Task* task)
{
    ...
    mirrorPart  = &mirror->extra.tmd->coords[D_dryfield_motel_room_6_80182D08[task->spawnArg1]];
...
void func_dryfield_motel_room_6_801811D4(Task* task)
{
    ...
    switch (task->state) {
        case 0:
            D_dryfield_motel_room_6_8018682C = NULL;
        ...
        case 3:
            ...
            break;
        case 4:
            D_dryfield_motel_room_6_8018682C = Task_SpawnFromTable(
                &D_dryfield_motel_room_6_80182D24, 1, 0, script->field_10);
