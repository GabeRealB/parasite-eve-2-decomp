...
s32 func_neo_ark_submarine_tunnel_8017F064(s32 arg0, s32 arg1, RoomEventMsg* arg2)
{
    ...
    if ((temp_s0 == 1) && (GameFlag_GetNibble(0xFF) == temp_s0) && (Game_Session->field_9 == 3)) {
    ...
    if ((arg2->field_2 == 2) && (GameFlag_GetNibble(0xBC) == 0)) {
        temp_s0_2 = Game_Session->field_9;
        if (temp_s0_2 == 1) {
    ...
    if ((temp_s0_3 == 3) && (D_neo_ark_submarine_tunnel_80181DF0 == 0) && (Game_Session->field_8 == 2) && (GameFlag_GetNibble(0xFF) == 0) && (Game_Session->field_9 == temp_s0_3)) {
    ...
    if ((arg2->field_2 == 2) && (D_neo_ark_submarine_tunnel_80181DF0 == 0)) {
        temp_s0_4 = Game_Session->field_8;
        if (temp_s0_4 == 1) {
            Gp_MsgPlayerWeapon(1);
            D_neo_ark_submarine_tunnel_80181DF0 = temp_s0_4;
        }
    }
    if ((arg2->field_2 == 3) && (D_neo_ark_submarine_tunnel_80181DF0 == 0) && (Game_Session->field_8 == 2)) {
        Gp_MsgPlayerWeapon(1);
        D_neo_ark_submarine_tunnel_80181DF0 = 1;
    }
    return 0;
