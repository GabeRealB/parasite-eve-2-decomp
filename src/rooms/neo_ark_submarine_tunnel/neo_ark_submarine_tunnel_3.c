...
/// Rear entry: select the decode mode and spawn the tunnel task while the
/// submarine is parked; afterwards record the requested room id.
...
/// Publish the message table, play the arrival sound and advance the task.
