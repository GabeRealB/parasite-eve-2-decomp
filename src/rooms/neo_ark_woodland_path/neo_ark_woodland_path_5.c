...
INCLUDE_RODATA("rooms/nonmatchings/neo_ark_woodland_path/neo_ark_woodland_path_5", D_neo_ark_woodland_path_8017D638);

INCLUDE_RODATA("rooms/nonmatchings/neo_ark_woodland_path/neo_ark_woodland_path_5", D_neo_ark_woodland_path_8017D648);
