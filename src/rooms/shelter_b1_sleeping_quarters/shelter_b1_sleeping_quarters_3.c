...
} _ShelterB1SleepingQuartersLight;

extern s32                             D_80070F70;
extern _ShelterB1SleepingQuartersLight D_80114FF8;
...
void func_shelter_b1_sleeping_quarters_8017EE58(GsCOORDINATE2* arg0, s32 arg1, s32 arg2, s32 arg3);
...
void func_shelter_b1_sleeping_quarters_8017FA40(GsCOORDINATE2* coord, s16 size);
...
/// Moves the effect's coordinate frame toward the coordinate in the spawn
/// argument. The first tick turns their world displacement into the frame's
/// parent space and scales it by 0xCC / 0x1000; every later tick steps the
    ...
    if (Gp_State1C->eventState == 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(coord);
                if (work->field_22 & 1) {
                    func_shelter_b1_sleeping_quarters_8017EE58(coord, (s16)++work->field_20, 0x200, 0x80);
                }
...
/// growing size while a wider, dimmer ring expands and fades behind them;
...
void func_shelter_b1_sleeping_quarters_8017F894(Task* arg0)
{
    ...
    if (flag != 0) {
        ...
        step       = mem->angle + 0x10;
        mem->angle = step;
        func_shelter_b1_sleeping_quarters_8017F500(coord, (s16)(step * 2), rgb);
        func_shelter_b1_sleeping_quarters_8017FA40(coord, mem->angle);
        if (mem->period >= 0x19) {
            rgb[0] = mem->period;
            rgb[1] = (u16)mem->period >> 1;
            rgb[2] = (u16)mem->period >> 2;
            func_shelter_b1_sleeping_quarters_8017F0DC(coord, (s16)(mem->step * 3 / 2), 0x60, rgb);
            mem->period -= 0x18;
            mem->step   += 0x30;
            return;
        }
