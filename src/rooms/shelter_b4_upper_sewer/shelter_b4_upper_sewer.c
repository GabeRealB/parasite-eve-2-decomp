...
/// and its `gpf 1` assembles to a different word.
...
extern _ShelterB4UpperSewerLight D_80114FF8;
    ...
    if (Gp_State1C->eventState != 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b4_upper_sewer_801803DC(coord, work->field_20, work->field_26 | 0x1000, work->field_24 | work->field_28);
                }
            ...
            case 2:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b4_upper_sewer_801803DC(coord, work->field_20, work->field_26, work->field_24 | work->field_28);
                }
                if ((s16)work->field_24 > 0) {
                    if ((s16)work->field_2A - 8 < (s16)work->field_22) {
                        work->field_24 -= 0x10;
    ...
    if (Gp_State1C->eventState == 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(coord);
                if (work->field_22 & 1) {
                    func_shelter_b4_upper_sewer_80184E44(coord, (s16)++work->field_20, 0x200, 0x80);
                }
...
void func_shelter_b4_upper_sewer_80185880(Task* task)
{
    ...
    if (Gp_State1C->eventState != 0) {
        ...
        func_shelter_b4_upper_sewer_80185A2C(coord, (s16)work->field_26);
