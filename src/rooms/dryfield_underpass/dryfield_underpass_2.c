...
s32 func_dryfield_underpass_8017D908(s32 arg0, s32 arg1, RoomEventMsg* in, RoomEventMsg* out)
{
    ...
    temp_v1 = in->field_2;
    if ((temp_v1 == 1) && (gGameSession->loc.place == temp_v1) && (GameFlag_GetNibble(0xC9) == 0)) {
...
void func_dryfield_underpass_8017D970(Task* arg0)
{
    ...
    if ((gGameSession->loc.place == 1) && (GameFlag_GetNibble(0xC9) == 0)) {
...
/// is the room index stored in `gGameSession.loc.room` (and the area-record id
