...
/// Panel titles for the weapon-usage and Parasite Energy-usage variants of
/// `func_shelter_1f_tent_8017E8AC`.
extern const char D_shelter_1f_tent_8017D624[];
extern const char D_shelter_1f_tent_8017D630[];

/// List of the usage panel, and the descriptor spawned under it.
extern UiList       D_shelter_1f_tent_80181C0C;
extern UiObjectDesc D_shelter_1f_tent_80181C30;

/// Title ("Telephone") and list of the menu run by
/// `func_shelter_1f_tent_8017EA60`.
