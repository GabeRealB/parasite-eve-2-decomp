...
extern const char D_shelter_1f_tent_8017D638[];

/// Captions of the telephone menu's rows ("Save", "Play Data", "Weapon Data",
/// "PE Data").
extern u8 D_shelter_1f_tent_80181998[];
extern u8 D_shelter_1f_tent_801819A0[];
extern u8 D_shelter_1f_tent_801819AC[];
extern u8 D_shelter_1f_tent_801819B8[];

/// Row captions of the play-data panel, one per row.
extern u8 D_shelter_1f_tent_801819C0[];
extern u8 D_shelter_1f_tent_801819F0[];
extern u8 D_shelter_1f_tent_801819C8[];
extern u8 D_shelter_1f_tent_801819CC[];
extern u8 D_shelter_1f_tent_801819D4[];
extern u8 D_shelter_1f_tent_801819E0[];
extern u8 D_shelter_1f_tent_801819F8[];
extern u8 D_shelter_1f_tent_80181A00[];
extern u8 D_shelter_1f_tent_80181A08[];

/// Suffix appended after a plain count on rows 1, 2, 3 and 6 of the play-data
/// panel.
extern u8 D_shelter_1f_tent_80181A10[];

/// Suffix appended after a percentage.
extern u8 D_shelter_1f_tent_80181A18[];

/// Help strings handed to the UI holder while the cursor rests on a row of
/// the play-data panel, one per row.
extern u8 D_shelter_1f_tent_80181A1C[];
extern u8 D_shelter_1f_tent_80181A48[];
extern u8 D_shelter_1f_tent_80181A6C[];
extern u8 D_shelter_1f_tent_80181A9C[];
extern u8 D_shelter_1f_tent_80181AD0[];
extern u8 D_shelter_1f_tent_80181B04[];
extern u8 D_shelter_1f_tent_80181B3C[];
extern u8 D_shelter_1f_tent_80181B70[];
extern u8 D_shelter_1f_tent_80181BA8[];

/// Lists of the play-data panel, the usage panel and the telephone menu, and
/// the descriptors of the panels they spawn.
extern UiList       D_shelter_1f_tent_80181BE4;
extern UiList       D_shelter_1f_tent_80181C0C;
extern UiObjectDesc D_shelter_1f_tent_80181C30;
extern UiObjectDesc D_shelter_1f_tent_80181C4C;
extern UiObjectDesc D_shelter_1f_tent_80181C68;
...
void func_shelter_1f_tent_8017D6C8(DialogPrompt* arg0, UiObject* arg1)
{
    u8  buf[0x20];
    u8* p;
    ...
    if (((arg1->status >> 16) == 1) || (arg1->status == 1)) {
        if (arg0->field_10 == arg0->field_8) {
            u8* tbl[9] = {
                D_shelter_1f_tent_80181A1C,
                D_shelter_1f_tent_80181A48,
                D_shelter_1f_tent_80181A6C,
                D_shelter_1f_tent_80181A9C,
                D_shelter_1f_tent_80181AD0,
                D_shelter_1f_tent_80181B04,
                D_shelter_1f_tent_80181B3C,
                D_shelter_1f_tent_80181B70,
                D_shelter_1f_tent_80181BA8,
            };
    ...
    switch (arg0->field_8) {
        ...
        case 4: {
            ...
            q[1] = 0x2E;
            Text_Strcat(p, D_shelter_1f_tent_80181A18);
            Text_DrawPrompt(arg1, -arg0->field_18, arg0->field_1A, buf, arg0->field_1C, 3, 2);
            break;
        }
        case 5: {
            ...
            req.centerMode = 0;
            req.field_E    = 1;
            func_8002E53C(&req, D_shelter_1f_tent_801819E0);
            cnt   = 326;
...
const char D_shelter_1f_tent_8017D610[] = "Play Data";

/// Drawn in place of a percentage for a row holding every recorded use.
const u8 D_shelter_1f_tent_8017D61C[] = "100.0%";
...
void func_shelter_1f_tent_8017DE94(DialogPrompt* arg0, UiObject* arg1)
{
    u8             buf[0x20];
    TextDrawReq    req;
    TextDrawReq*   r;
    ...
    limit = 1;
    if (value >= 10000) {
        Text_DrawPrompt(arg1, -arg0->field_18, arg0->field_1A, D_shelter_1f_tent_8017D61C, arg0->field_1C, 3, 2);
    } else {
        for (i = 2; i > 0; i--) {
            limit *= 10;
        }
...
void func_shelter_1f_tent_8017E290(UiList* list, UiObject* obj)
{
    RoomItemUsage* work;
    s32            count;
    s32            total;
...
void func_shelter_1f_tent_8017E58C(UiList* list, UiObject* obj)
{
    RoomPeUsage* work;
    s16*         p;
    s32          count;
...
const char D_shelter_1f_tent_8017D624[] = "Weapon Data";
const char D_shelter_1f_tent_8017D630[] = "PE Data";
...
void func_shelter_1f_tent_8017E8AC(Task* task)
{
    UiObject* obj;
    UiList*   list;
    Task*     child;
    ...
    obj           = task->spawnArg2;
    obj->field_2E = 0;
    list          = &D_shelter_1f_tent_80181C0C;
    if (task->spawnArg1 == 0) {
        Ui_DrawText((UiPanel*)obj, D_shelter_1f_tent_8017D624);
    } else {
        Ui_DrawText((UiPanel*)obj, D_shelter_1f_tent_8017D630);
    }
    if (task->state == 0) {
        ...
        task->work = work;
        Ui_SpawnFromDesc(&D_shelter_1f_tent_80181C30, 0, 0, 1, obj);
        if (task->spawnArg1 == 0) {
            func_shelter_1f_tent_8017E290(list, obj);
        } else {
            func_shelter_1f_tent_8017E58C(list, obj);
        }
...
void func_shelter_1f_tent_8017EA60(Task* task)
{
    ...
    if (ready == 0) {
        ...
        Ui_DrawText((UiPanel*)obj, D_shelter_1f_tent_8017D638);
        Ui_UpdateListNoAnim(list, obj);
    }
    if (obj->field_2E == 6) {
        obj->field_2E = 0;
...
/// installs `func_shelter_1f_tent_8017F448` as its exit callback; every
/// frame it draws the prompt lines.
void func_shelter_1f_tent_8017ED58(Task* task)
{
    UiObject* obj;
    ...
    if (task->state == 0) {
        ...
        task->exitCallback = func_shelter_1f_tent_8017F448;
        task->state       += 1;
    }
...
void func_shelter_1f_tent_8017EDB4(u8* str, s32 decimals)
{
    s32 len;
...
u8* func_shelter_1f_tent_8017EE24(u8* buf, s32 value, s32 decimals)
{
    s32 limit;
    s32 i;
    s32 len;
    ...
    Text_Strcat(buf, D_shelter_1f_tent_80181A18);
    return buf;
}

/// Task body of the play-data panel: on its first frame it spawns
/// `D_shelter_1f_tent_80181C30` and lays out the list; every frame it
/// draws the title, updates the list and closes on cancel.
void func_shelter_1f_tent_8017EF18(Task* task)
{
    UiObject* obj;
    UiList*   list;

    list          = &D_shelter_1f_tent_80181BE4;
    obj           = task->spawnArg2;
    obj->field_2E = 0;
    Ui_DrawText((UiPanel*)obj, D_shelter_1f_tent_8017D610);
    if (task->state == 0) {
        Ui_SpawnFromDesc(&D_shelter_1f_tent_80181C30, 0, 0, 1, obj);
        Ui_LayoutListPanel(list, (UiPanel*)obj);
        obj->field_12 += 5;
...
void func_shelter_1f_tent_8017F008(UiPanel* arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, u32 arg5, s32 arg6)
{
...
void func_shelter_1f_tent_8017F10C(DialogPrompt* prompt, UiObject* obj)
{
    s32 sel;

    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_shelter_1f_tent_80181998, prompt->field_1C, 1, 0);
    sel = prompt->field_C;
...
/// `D_shelter_1f_tent_80181C4C` and moves the owning task to state 2.
void func_shelter_1f_tent_8017F1F0(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_shelter_1f_tent_801819A0, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_shelter_1f_tent_80181C4C, 0, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
...
/// `D_shelter_1f_tent_80181C68` for weapons and moves the owning task to
/// state 2.
void func_shelter_1f_tent_8017F2B8(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_shelter_1f_tent_801819AC, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_shelter_1f_tent_80181C68, 0, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
...
/// `D_shelter_1f_tent_80181C68` for Parasite Energy and moves the owning
/// task to state 2.
void func_shelter_1f_tent_8017F380(DialogPrompt* prompt, UiObject* obj)
{
    Text_DrawPrompt(obj, prompt->field_18, prompt->field_1A, D_shelter_1f_tent_801819B8, prompt->field_1C, 1, 0);
    if (prompt->field_C == 1 && Pad_CheckButtons(0, 1, Pad_MaskConfirm) != 0) {
        SndEvt_EnqueueType6(0x16, 0, 0);
        Ui_SpawnFromDesc(&D_shelter_1f_tent_80181C68, 1, 1, 1, obj);
        obj->field_2E     = 6;
        obj->status       = 0;
        obj->owner->state = 2;
    }
    ...
    switch (task->state) {
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                taskKill(D_shelter_1f_tent_801843C0);
                task->state++;
            } else if (Task_PollKill(D_shelter_1f_tent_801843C0, &poll) != 0) {
                task->state++;
            }
            break;
        case 6:
...
void func_shelter_1f_tent_8017FDA8(Task* task)
{
    char pad[0x10];
}
...
const TaskFuncTable3 D_shelter_1f_tent_8017D6A4 = {
    {
