...
s32 func_dryfield_night_motel_room_1_8017D5F0(void)
{
    return 0;
}
...
void func_dryfield_night_motel_room_1_8017D6D4(Task* task)
{
}

/// The room task's three states.
const TaskFuncTable3 D_dryfield_night_motel_room_1_8017D5C4 = {
