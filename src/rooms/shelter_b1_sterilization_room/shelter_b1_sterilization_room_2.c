...
typedef struct {
    ...
    /* 0x14 */ s16 field_14;
    /* 0x16 */ s16 field_16;
} SterilizationRoomCapScript;
STATIC_ASSERT_SIZEOF(SterilizationRoomCapScript, 0x18);
...
void func_shelter_b1_sterilization_room_8017F550(Task* task)
{
    ...
    s32                         key;
    s32                         one;
    SterilizationRoomCapScript* script;
    McSaveData*                 save;
    ...
    switch (task->state) {
        ...
        case 3:
            ...
            break;
        case 4:
            D_shelter_b1_sterilization_room_8018C33C =
                Task_SpawnFromTable(&D_shelter_b1_sterilization_room_80184E1C, 1, 0, script->field_10);
        ...
        case 5:
            if (Pad_CheckButtons(0, 1, Pad_MaskConfirm | Pad_MaskCancel) != 0) {
                ...
                Task_Kill(D_shelter_b1_sterilization_room_8018C33C);
                task->state++;
            } else if (Task_PollKill(D_shelter_b1_sterilization_room_8018C33C, &poll) != 0) {
                task->state++;
            }
            break;
        case 6:
