...
extern void func_shelter_b2_north_maintenance_walkway_80181E58(GsCOORDINATE2* arg0, s16 arg1, s16 arg2, u8* arg3);
void        func_shelter_b2_north_maintenance_walkway_80182284(GsCOORDINATE2* coord, s16 frame, u8* rgb);
void        func_shelter_b2_north_maintenance_walkway_80183188(GsCOORDINATE2* coord, s16 frame, u8* rgb);
    ...
    if (flag != 0) {
        ...
        switch (arg0->state) {
            ...
            case 1:
                ...
                func_shelter_b2_north_maintenance_walkway_80181E58(coord, 0x300 - (u16)mem->angle * 2, 0x80, rgb);
                if (arg0->spawnArg1 == 0) {
                    mem->scale  = 0xFF;
                    arg0->state = 2;
                    rgb[0]      = mem->scale;
