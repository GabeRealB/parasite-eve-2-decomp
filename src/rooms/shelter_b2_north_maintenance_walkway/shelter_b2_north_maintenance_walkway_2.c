...
extern _WalkwayLight D_80114FF8;
...
void func_shelter_b2_north_maintenance_walkway_8017F85C(GsCOORDINATE2* arg0, u16 arg1, u16 arg2, u16 arg3);
void func_shelter_b2_north_maintenance_walkway_8018081C(GsCOORDINATE2* coord, s16 size);
void func_shelter_b2_north_maintenance_walkway_80180D48(GsCOORDINATE2* arg0, s32 arg1);
void func_shelter_b2_north_maintenance_walkway_801810C0(GsCOORDINATE2* arg0, s16 arg1, u8* arg2);
void func_shelter_b2_north_maintenance_walkway_80181E58(GsCOORDINATE2* arg0, s32 arg1, s32 arg2, u8* rgb);
void func_shelter_b2_north_maintenance_walkway_80182284(GsCOORDINATE2* arg0, s16 arg1, u8* arg2);
void func_shelter_b2_north_maintenance_walkway_80182B08(GsCOORDINATE2* arg0, GsCOORDINATE2* arg1, s16 arg2, s16 arg3);
void func_shelter_b2_north_maintenance_walkway_80183188(GsCOORDINATE2* arg0, s16 arg1, u8* arg2);
    ...
    if (Gp_State1C->eventState != 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b2_north_maintenance_walkway_8017F85C(coord, work->field_20, work->field_26 | 0x1000, work->field_24 | work->field_28);
                }
            ...
            case 2:
                ...
                if (work->field_22 & 1) {
                    work->field_20++;
                    func_shelter_b2_north_maintenance_walkway_8017F85C(coord, work->field_20, work->field_26, work->field_24 | work->field_28);
                }
                if ((s16)work->field_24 > 0) {
                    if ((s16)work->field_2A - 8 < (s16)work->field_22) {
                        work->field_24 -= 0x10;
...
/// position of `arg0`. The low twelve bits of `arg2` are its half-size, scaled
...
void func_shelter_b2_north_maintenance_walkway_8017FB20(GsCOORDINATE2* arg0, s32 arg1, s32 arg2, u8* rgb)
{
...
void func_shelter_b2_north_maintenance_walkway_8017FF44(GsCOORDINATE2* arg0, s16 arg1, u8* arg2)
{
...
void func_shelter_b2_north_maintenance_walkway_80180670(Task* arg0)
{
    ...
    if (flag != 0) {
        ...
        if (mem->period >= 0x19) {
            ...
            func_shelter_b2_north_maintenance_walkway_8017FB20(coord, (s16)(mem->step * 3 / 2), 0x60, rgb);
            mem->period -= 0x18;
            mem->step   += 0x30;
            return;
        }
...
/// It also sets the gameplay light slot at the glow's position with a
    ...
    if (flag != 0) {
        ...
        switch (arg0->state) {
            ...
            case 1:
                ...
                func_shelter_b2_north_maintenance_walkway_80182284(coord, mem->angle, rgb);
                rgb[0] = rgb[0] >> 1;
                rgb[1] = rgb[1] >> 1;
                rgb[2] = rgb[2] >> 1;
            ...
            case 2:
                if (mem->scale >= 0x11) {
                    ...
                    rgb[1] = (u16)mem->scale >> 2;
                    rgb[2] = (u16)mem->scale >> 1;
                    func_shelter_b2_north_maintenance_walkway_80183188(coord, mem->angle * 3, rgb);
                    mem->scale -= 0x10;
                    mem->angle -= 8;
                    return;
                }
    ...
    if (Gp_State1C->eventState < 2) {
        ...
        switch (task->state) {
            case 0:
                ...
                objCoord->coord.t[0] = D_shelter_b2_north_maintenance_walkway_80183C4C[0].vx;
                objCoord->coord.t[1] = D_shelter_b2_north_maintenance_walkway_80183C4C[0].vy;
                objCoord->coord.t[2] = D_shelter_b2_north_maintenance_walkway_80183C4C[0].vz;
                objCoord->flg        = 0;
                Gp_UpdateCoord(objCoord);
                task->state      = 1;
                coord.sub        = work->parent;
                vec              = &D_shelter_b2_north_maintenance_walkway_80183C4C[1];
...
void func_shelter_b2_north_maintenance_walkway_80182F00(Task* task)
{
    ...
    switch (task->state) {
        ...
        case 2:
            ...
            func_shelter_b2_north_maintenance_walkway_80181E58(objCoord, 0x100, 0x100, rgb);
            func_shelter_b2_north_maintenance_walkway_80181E58(objCoord, work->scale, work->scale, rgb);
            if (work->age >= 7) {
                task->state = 3;
            }
            break;
