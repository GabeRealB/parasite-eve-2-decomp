...
/// "ready" banner and the hand-off wait on `gGameSession::field_4`, gated on
...
/// "ready" banner and the hand-off wait on `gGameSession::field_4`, state 4
...
/// `gGameSession::field_4`, then the wave loop over
