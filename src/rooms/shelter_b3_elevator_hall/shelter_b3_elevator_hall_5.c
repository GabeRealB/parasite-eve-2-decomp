...
} _ShelterB3ElevatorHallLight;

extern s32                         D_80070F70;
extern _ShelterB3ElevatorHallLight D_80114FF8;
extern s32                         Gp_LcgState;

void func_shelter_b3_elevator_hall_8017ED84(GsCOORDINATE2* arg0, s32 arg1, s32 arg2, u8* rgb);
void func_shelter_b3_elevator_hall_8017F1A8(GsCOORDINATE2* arg0, s16 arg1, u8* arg2);
void func_shelter_b3_elevator_hall_8017FA80(GsCOORDINATE2* coord, s16 size);
void func_shelter_b3_elevator_hall_8017FFAC(GsCOORDINATE2* arg0, s32 arg1);
...
void func_shelter_b3_elevator_hall_8017F8D4(Task* arg0)
{
    ...
    if (flag != 0) {
        ...
        step       = mem->angle + 0x10;
        mem->angle = step;
        func_shelter_b3_elevator_hall_8017F1A8(coord, step * 2, rgb);
...
/// It also points the gameplay light slot at the glow with a random
