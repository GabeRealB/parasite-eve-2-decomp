...
extern RoomsShared8017ff88Shade D_shelter_b3_elevator_hall_80182B48[];
    ...
    if (Gp_State1C->eventState == 0) {
        ...
        switch (task->state) {
            ...
            case 1:
                ...
                Gp_UpdateCoord(coord);
                if (work->field_22 & 1) {
                    func_shelter_b3_elevator_hall_80181594(coord, (s16)++work->field_20, 0x200, 0x80);
                }
...
/// Draws a semi-transparent textured sprite (`POLY_FT4`, tpage 0x2A, clut
