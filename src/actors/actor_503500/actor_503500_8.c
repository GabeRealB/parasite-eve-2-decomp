...
void func_actor_503500_8013C558(Actor503500* arg0)
{
    ...
    switch (work->field_F1) {
        case 0:
            ...
            arg0->field_20->reactionFlags &= 0xF0;
...
void func_actor_503500_80140654(Actor503500* arg0)
{
    ...
    if (func_actor_503500_801360BC(arg0->spawnArg1, 4) != 0 && work->field_3D0 < 3 &&
        (u32)D_80070F70 % 12 == 0) {
        for (i = 8, j = 0; i > 0; i--) {
            Gp_SpawnEff(0x60070, &arg0->extra->coords[i], 0xB0008600, &D_actor_503500_8016F448[j]);
            j++;
            j = (j < 3) ? j : 0;
        }
    }
...
void func_actor_503500_80141448(Actor503500* arg0)
{
    ...
    func_actor_503500_8014176C(work->pts, arg0->extra->coords);
    for (i = 8; i >= 2; i--) {
    ...
    func_actor_503500_80142220(work->angles, arg0->extra->coords);
}
...
void func_actor_503500_80142980(Actor503500* arg0)
{
    ...
    if (func_actor_503500_801360BC(arg0->spawnArg1, 3) != 0) {
        if (!(D_80070F70 & 3)) {
            for (i = 0, j = 0; i < 2; i++) {
                Gp_SpawnEff(0x60070, &arg0->extra->coords[i], 0x81018A00, &D_actor_503500_80171564[j]);
                j++;
                j = j < 5 ? j : 0;
            }
        }
    ...
    for (i = 0; i < count; i++) {
        if ((rec[i].key & 0xFFFF0000) == 0x10000) {
            ...
            if (((GameActor*)player->work)->field_954 != 2 &&
                ...
                SndEvt_EnqueueType6(7, pan, (s8)(Gp_GetObjDepth(pcoord) / 2));
            }
        }
    }
}
...
void func_actor_503500_80143AC0(Task* arg0)
{
    ...
    if (++arg0->killCountdown == 0x11) {
        ...
        pan   = (s8)Gp_GetObjPan(coord);
        SndEvt_EnqueueType6(0x54300002, pan, (s8)Gp_GetObjDepth(coord));
    }
}
...
void func_actor_503500_80144300(Task* arg0)
{
    ...
    pan = (s8)Gp_GetObjPan(coord);
    SndEvt_EnqueueType6(0x40230005, pan, (s8)(Gp_GetObjDepth(coord) / 2));
...
void func_actor_503500_801448E8(Task* arg0)
{
    ...
    if (arg0->spawnArg1 == 0) {
        ...
        pan = (s8)Gp_GetObjPan(coord);
        SndEvt_EnqueueType6(0x40230008, pan, (s8)(Gp_GetObjDepth(coord) / 2));
    } else {
        eff  = Gp_SpawnEff(0x6018D, coord, 0, NULL);
        pan2 = (s8)Gp_GetObjPan(coord);
        SndEvt_EnqueueType6(0x40230007, pan2, (s8)(Gp_GetObjDepth(coord) / 2));
    }
    if (eff == NULL) {
...
void func_actor_503500_80144E8C(Task* arg0)
{
    ...
    pan = (s8)Gp_GetObjPan(coord);
    SndEvt_EnqueueType6(0x4023000A, pan, (s8)(Gp_GetObjDepth(coord) / 2));
