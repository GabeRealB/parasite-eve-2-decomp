    ...
    switch (work->field_CC) {
        case 0:
            if (++work->field_C6 >= 0x1F) {
                ...
                SndEvt_EnqueueType6(0x4023000B, pan, (s8)(Gp_GetObjDepth(coord) / 2));
                work->field_C6 = 0;
                work->field_CC++;
            }
            break;
...
INCLUDE_RODATA("actors/nonmatchings/actor_503500/actor_503500_9", D_actor_503500_80132218);

INCLUDE_RODATA("actors/nonmatchings/actor_503500/actor_503500_9", D_actor_503500_80132224);

INCLUDE_RODATA("actors/nonmatchings/actor_503500/actor_503500_9", D_actor_503500_80132230);
...
void func_actor_503500_801455A4(Task* arg0)
{
    ...
    pan = (s8)Gp_GetObjPan(coord);
    SndEvt_EnqueueType6(0x4023000C, pan, (s8)(Gp_GetObjDepth(coord) / 2));
        ...
        switch (work->field_40) {
            case 0:
                ...
                if (work->field_3C >= 0x5F) {
                    ...
                    coord = arg0->extra->coords;
                    pan   = (s8)Gp_GetObjPan(coord);
                    SndEvt_EnqueueType6(0x40230014, pan, (s8)(Gp_GetObjDepth(coord) / 2));
                } else if (work->field_3C == 0x5A) {
                    coord2 = arg0->extra->coords;
                    pan2   = (s8)Gp_GetObjPan(coord2);
                    SndEvt_EnqueueType6(0x4023000D, pan2, (s8)(Gp_GetObjDepth(coord2) / 2));
                }
                return;
            case 1:
                work->field_3C++;
    ...
    switch (work->field_A8) {
        case 0:
            ...
            if (gGameSession->eventState == 0) {
                ...
                coord                 = arg0->extra->coords;
                pan                   = (s8)Gp_GetObjPan(coord);
                SndEvt_EnqueueType6(0x4023000F, pan, (s8)(Gp_GetObjDepth(coord) / 2));
            }
            goto next;
        case 1:
            if (gGameSession->eventState == 0) {
