...
static __inline__ void Actor401300_BindMatrices(Actor401300* actor)
{
    ...
    work          = actor->field_1C;
    obj           = actor->field_2C;
    obj->field_1C = &work->field_C28;
    obj->field_20 = &work->field_C48;
}
...
void func_actor_401300_80134454(GpEnemy* enemy, Actor401300* actor)
{
    ...
    Gp_AnimInitCtxSlots(&((Actor401300AnimWork*)work)->anim, &D_actor_401300_80158838, (GpAnimObj*)obj,
                        ((Actor401300AnimWork*)work)->pad_32C, ((Actor401300AnimWork*)work)->slots);
    Gp_AnimInitCtxSlots(&((Actor401300AnimWork*)work)->blendAnim, &D_actor_401300_80158838, (GpAnimObj*)obj,
    ...
    work->field_AB0.field_C  = (GpRec18*)&work->field_AD0;
    work->field_AB0.field_8  = &work->field_920;
    work->field_AB0.field_10 = 0;
    work->field_AB0.field_12 = 0;
    work->field_AB0.field_14 = 0;
    work->field_AB0.field_18 = 0x3000D;
    work->field_AB0.field_1C = 0x15E;
    work->field_AB0.flags    = 1;
    Gp_LinkObj(2, &work->field_AB0);
    work->field_C88        = 0;
    work->field_AB0.flags |= 0x4000;
    Gp_InitRec18Table(work->field_AB0.field_C, 0xC, 0);

    body           = &work->field_970;
    body->field_C  = (GpRec18*)&work->field_990;
    body->field_18 = 0x30000;
    body->field_8  = &Gfx_ViewCoord;
    body->field_10 = 0;
    body->field_12 = 0;
    body->field_14 = 0;
    body->field_1C = 0x280;
    ...
    dir.vz         = 0;
    head           = &work->field_BF0;
    head->field_8  = &actor->field_2C->field_8[3];
    head->field_C  = (GpRec18*)&work->pad_C10;
    v              = &dir;
    head->field_10 = v->vx;
    head->field_12 = v->vy;
    head->field_14 = v->vz;
    ...
    ((Task*)actor)->field_24 = &D_actor_401300_80158988;
    ...
    work->field_910.field_0 = &actor->field_2C->field_8[1];
    ...
    Actor401300_InitPose(actor->field_2C->field_8, work);
    ((Task*)actor)->state++;
}
...
void func_actor_401300_80134BA4(Actor401300* arg0, s16 arg1, s32 arg2)
{
    ...
    work->field_910.field_4 = 0x300;
    work->field_910.field_6 = 2;
    func_800FDB18(Gp_GetIdParam1(arg2) & 0xFFFF, &arg0->field_2C->field_8[sc->pad], sc, &work->field_910);
    *(u32*)G_SCRATCH_HEAD += 8;
}
...
void func_actor_401300_8013CBAC(Actor401300* arg0)
{
    ...
    *(Actor401300AimScratch**)G_SCRATCH_HEAD = head - 1;
    ...
    if (work->field_8A2 == 2) {
        if (work->field_89E == 0) {
            if ((s16)func_actor_401300_8013267C(arg0->field_2C->field_8, 0x15E, 0x16) != 0) {
                Actor401300_MoveForward(arg0->field_2C->field_8, 0x16);
            }
        } else {
            if ((s16)func_actor_401300_8013267C(arg0->field_2C->field_8, 0x15E, 5) != 0) {
                Actor401300_MoveForward(arg0->field_2C->field_8, 5);
            }
        }
...
void func_actor_401300_8013D6C4(Actor401300* arg0)
{
    ...
    if (work->field_4 != 0) {
        ...
        work->field_6            = 0;
        work->field_8            = 0;
        work->field_BF0.field_18 = Gp_PackObjPair((GpObj50*)enemy, 1);
        work->field_8B6          = 0x200;
        work->field_8BA          = 0x80;
        return;
    }
    func_actor_401300_801323B0(arg0->field_2C->field_8, work->field_AD0, 0xC);
...
void func_actor_401300_8013E930(Actor401300* arg0)
{
    ...
    switch (work->field_8A2) {
        case 0x1F:
            ...
            work->field_8B2 = 0;
            blk->angle      = Actor401300_YawTo(arg0->field_2C->field_8, head[-1].delta.vx, delta->vz);
            if (work->field_6 >= 0xB) {
                work->field_8A2 = 0x20;
                work->field_89C = 1;
            ...
            blk->angle += Actor401300_Yaw(arg0->field_2C->field_8);
        ...
        case 0x20:
            ...
            if (func_actor_401300_80132910(arg0, work->field_990, 0xC) != 0 && player->field_954 != 2 && work->field_6 >= 8 &&
                ...
                if (Gp_DispatchMsg(Game_GetPtrSlot(3), 0x3F8, (s32)&work->field_CEC, 0) == 0) {
                    Gp_SpawnPadLerp(0x10, 8, 0xFF);
                    SndEvt_EnqueueType6(6, (s8)Gp_GetObjPan((GpObj38*)((TmdObject*)task->extra)->field_8),
                                        (s8)Gp_GetObjDepth((GpObj38*)((TmdObject*)task->extra)->field_8));
                    work->field_D20         = 1;
                    work->field_CAC.field_0 = (s32)&D_actor_401300_801588F0;
                    blk->delta.vx           = work->field_D04 - ((TmdObject*)task->extra)->field_8->coord.t[0];
                    blk->delta.vy           = work->field_D06 - ((TmdObject*)task->extra)->field_8->coord.t[1];
                    blk->delta.vz           = work->field_D08 - ((TmdObject*)task->extra)->field_8->coord.t[2];
                    blk->angle              = Actor401300_YawTo(((TmdObject*)task->extra)->field_8, head[-1].delta.vx, delta->vz);
                    if (abs(blk->angle) < 0x400) {
                        amount                  = -0x46;
                        work->field_CAC.field_4 = 4;
                        work->field_CE4.vy      = blk->angle + Actor401300_Yaw(((TmdObject*)task->extra)->field_8);
                        ret                     = Gp_DispatchMsg(Game_GetPtrSlot(3), 0x3F9, Gp_PackObjPair((GpObj50*)enemy, 2), 0);
                    } else {
                        amount                  = 0x46;
                        work->field_CAC.field_4 = 5;
                        work->field_CE4.vy      = blk->angle + Actor401300_Yaw(((TmdObject*)task->extra)->field_8) + 0x800;
                    ...
                    work->field_D22 = 0;
                    vec             = &blk->delta;
                    Gfx_MatrixCol2(&((TmdObject*)task->extra)->field_8->coord, vec);
                    blk->delta.vy = 0;
                    VectorNormalSS(vec, vec);
                    gte_lddp(amount);
                    gte_ldsv(vec);
            ...
            if (work->field_D20 == 0) {
                Actor401300_MoveForwardNonzero(arg0->field_2C->field_8, work->field_14);
            }
            Actor401300_ResetActorYaw(arg0);
            break;
        case 0x21:
            ...
            if (func_actor_401300_80132C78(arg0->field_2C->field_8, (GpRec18*)work->field_AD0, 0xC, 0x57) == 0) {
                ...
                if (cur < 0x11 && work->field_D20 == 0) {
                    if ((s16)func_actor_401300_8013267C(arg0->field_2C->field_8, 0x15E, (s16)(0x54 - cur * 0x54 / 16)) != 0) {
                        Actor401300_MoveForwardNonzeroSave(save, arg0->field_2C->field_8, 0x54 - work->field_6 * 0x54 / 16);
                    }
                }
            }
            func_actor_401300_80132910(arg0, work->field_990, 0xC);
