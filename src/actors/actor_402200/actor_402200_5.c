...
INCLUDE_ASM("actors/nonmatchings/actor_402200/actor_402200_5", func_actor_402200_80135D5C);

INCLUDE_ASM("actors/nonmatchings/actor_402200/actor_402200_5", func_actor_402200_80136184);

INCLUDE_ASM("actors/nonmatchings/actor_402200/actor_402200_5", func_actor_402200_801368E0);
    ...
    switch (kind) {
        case 0:
            ...
            for (i = 0; D_actor_402200_80153C78[i].field_0 != 0; i++) {
                if (Game_Session->field_7 == D_actor_402200_80153C78[i].field_2 && Game_Session->field_6 == D_actor_402200_80153C78[i].field_4) {
            ...
            work->field_716 = 0x16;
            cues            = D_actor_402200_80154144[Game_Session->field_7];
            if (cues != NULL) {
