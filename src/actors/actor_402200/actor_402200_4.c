    ...
    switch (work->field_6CE) {
        ...
        case 3:
            if (work->field_6D6 > 0) {
                ...
                if (timer <= 0) {
                    if (Wip_SysConfig.field_18 > D_actor_402200_80153C0C[D_8011541B]) {
                        if (work->field_6F8 == 0) {
                            work->field_6F8 = 1;
                        } else {
            ...
            switch (sub) {
                ...
                case 1:
                    if ((CdCmd_IsIdle() & 0xFFFF) == 1) {
                        coord = ((Actor402200*)Game_GetPtrSlot(3))->field_2C->field_8;
                        SndEvt_EnqueueType6(0x70010001, (s8)Gp_GetObjPan((GpObj38*)coord), (s8)Gp_GetObjDepth((GpObj38*)coord));
                        work->field_6D4 = 2;
                    }
                    break;
                case 2:
