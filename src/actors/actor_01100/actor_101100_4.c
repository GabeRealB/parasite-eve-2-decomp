...
void Actor01100_Fn06C0C(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, void* scratch)
{
    GpLinkXform* xform;
    s32          off;
    s32          i;
...
/// runs last.
void Actor01100_Fn06D3C(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, void* scratch)
{
    GpLinkXform* xform;
    s16          walk;
