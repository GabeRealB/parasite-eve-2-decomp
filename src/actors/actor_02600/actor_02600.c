    ...
    *(VECTOR**)PSX_SCRATCH_ADDR(0x3FC) = delta;
    ...
    switch (state) {
        case 0:
            ...
            delta->vz         = dz;
            dx                = scratchEnd[-1].vx;
            if ((SquareRoot0((dx * dx) + (dz * dz)) < 0x9C4) || (work->field_3D0 != 0) || (Gp_StateF0.field_3 == 2)) {
                work->field_39C = 1;
                work->field_392 = 0xD;
                Gp_ArmStateF0(1);
            }
...
void Actor02600_Fn02FFC(GpEnemy* ctx, Task* actor)
{
    ...
    func_800B3F84((GpAnimCtx*)work, Actor02600_D08ACC, (TmdObject*)obj, work->field_154, ((Actor105500Anim*)work)->slots);
    for (i = 1; i < 8; i++) {
