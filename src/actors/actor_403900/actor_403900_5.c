    ...
    switch (kind) {
        case 0:
            ...
            for (i = 0; D_actor_403900_80153C7C[i].field_0 != 0; i++) {
                if (gGameSession->field_7 == D_actor_403900_80153C7C[i].field_2 && gGameSession->field_6 == D_actor_403900_80153C7C[i].field_4) {
            ...
            work->field_716 = 0x27;
            cues            = D_actor_403900_8015409C[gGameSession->field_7];
            if (cues != NULL) {
