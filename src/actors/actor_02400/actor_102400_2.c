...
move_done:
        ...
        switch ((u32)work->records[i].key >> 16) {
            case 2:
                ...
                if (!(work->records[i].key & 0x8000)) {
                    kind = Actor02400_D045DC[work->records[i].key & 0x7F];
                }
                ...
                switch (kind) {
                    ...
                    case 1:
                        ...
                        if (Actor02400_D0463C[param] == 0 && lastId != work->records[i].key) {
    ...
    if (Gp_FindRec18(&work->field_E0, 0) != 0) {
        ...
        work->field_14C = 1;
        Gp_SpendMp(Actor02400_D045D8[work->field_14E]);
    }
    if (work->field_152 != 0) {
        work->field_152--;
        if (work->field_152 <= 0) {
...
INCLUDE_RODATA("actors/nonmatchings/actor_02400/actor_102400_2", Actor02400_D0003C);
