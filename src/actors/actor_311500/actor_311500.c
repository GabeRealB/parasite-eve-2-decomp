...
typedef struct Actor311500 {
    ...
    /// Phase run by `func_actor_311500_80163334`: 0 sets the actor up, 1 idles
    /// until it is hit, 2 plays the hit reaction and returns to 1 or, once the
    /// hit points are gone, goes on to 3, which runs the death sequence; 4 does
    /// nothing.
    /* 0x30 */ u32 field_30;
} Actor311500;
