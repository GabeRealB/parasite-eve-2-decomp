...
/* Defined in other units of this overlay. `func_actor_400600_80139CAC` is
 * called both with and without an argument, so it keeps an unprototyped
 * declaration, as `func_actor_400600_8013A0B0` does in the header. */
