...
void ActorsShared8013845cSub0(Task* task)
{
    ...
    work    = memCalloc(sizeof(Actor104900Work), 0);
    if (work == NULL) {
        Task_CallExit(task);
        return;
    }
    ...
    obj->pos.vz         = 0;
    obj->radius         = 0x2EE;
    obj->key            = Gp_PackPair(&D_actor_104900_80139318, 5);
    obj->flags          = 1;
...
INCLUDE_ASM("actors/nonmatchings/actor_104900/actor_104900_4", func_actor_104900_80138374);
