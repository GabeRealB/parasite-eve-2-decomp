...
void func_actor_105300_8013246C(GpEnemy* arg0, Actor05300* arg1)
{
    SVECTOR          ofs;
    VECTOR           pos;
    Actor05300Obj2C* obj;
    ...
    if ((s16)work->field_330 == 0) {
        Gp_ReleaseStateF0Add((GpObj20E*)arg1, D_actor_105300_80133A2C[work->field_334]);
        work->field_330 = 1;
...
const GpEnemyTaskFuncTable3 D_actor_105300_80131E30 = {
    {
        ...
        (GpEnemyTaskFunc)func_actor_105300_80133468,
        (GpEnemyTaskFunc)func_actor_105300_8013246C,
    },
};
