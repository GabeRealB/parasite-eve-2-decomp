    ...
    do {
        switch (work->field_1A4[i].field_4 & 0xFFFF0000) {
            case 0x10000:
                ...
                Gp_SpawnEff(0x60030, ((TmdObject*)arg0->extra)->field_8, 0x200, &D_actor_207200_8014E7BC);
                Gp_SpawnEff(0x60030, ((TmdObject*)arg0->extra)->field_8, 0x200, &D_actor_207200_8014E7BC);
                Gp_SpawnEff(0x6009E, ((TmdObject*)arg0->extra)->field_8, 0, &D_actor_207200_8014E7C4);
                ...
                break;
            case 0x20000:
                sc->delta.vx.w = Wip_SysConfig.field_4->t[0] - coord->coord.t[0];
                sc->delta.vy.w = Wip_SysConfig.field_4->t[1] - coord->coord.t[1];
                sc->delta.vz.w = Wip_SysConfig.field_4->t[2] - coord->coord.t[2];
