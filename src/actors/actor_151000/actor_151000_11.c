...
/// Resets animation slots 1..0x12 to clip `field_480` at rate 1, without a
...
void func_actor_151000_80132610(void)
{
    ...
    do {
        ...
        Gp_AnimResetSlot(&D_actor_151000_8013D37C->anim, i, (s16)D_actor_151000_8013D37C->field_480);
        i++;
    } while (i < 0x13);
