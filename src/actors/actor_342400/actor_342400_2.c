...
{
    Actor342400Work* work = (Actor342400Work*)arg0->work;
    Actor342400Work* state;
    Actor342400Work* state2;
    s32              angle;
    s32              cur;
    s32              aim;

    if ((s16)++work->field_412 > work->field_446) {
        state            = (Actor342400Work*)arg0->work;
        state->field_420 = 2;
        state->field_422 = 0;
        return;
    }
    ...
    if (work->field_43A < 0xDAC && (aim = (u16)work->field_444, (aim < 0x3C0 || aim > 0xC40))) {
        ...
        if (++work->field_42C >= 0x10) {
            Gp_ArmStateF0(1);
            state2            = (Actor342400Work*)arg0->work;
            state2->field_420 = 3;
            state2->field_422 = 0;
        }
    } else {
...
void func_actor_342400_80166C68(Task* arg0)
{
    ...
    if ((u16)(work->field_412++ - 0x1D) < 0xD) {
        ...
        speed                                          = (((Actor342400Work*)arg0->work)->field_41C * scale) << 0xC >> 0x10;
        ((TmdObject*)arg0->extra)->coords->coord.t[0] += ((rsin(angle) << 4) * speed) >> 0x10;
        ((TmdObject*)arg0->extra)->coords->coord.t[2] += ((rcos(angle) << 4) * speed) >> 0x10;
        ((TmdObject*)arg0->extra)->coords->flg         = 0;
    }
...
void func_actor_342400_80168A28(Task* arg0)
{
    ...
    enemy->recs = 0;
    objs        = (Actor342400Work*)arg0->work;
