...
/// so the caller skips this frame's state handler.
...
/// `func_actor_341700_80164CDC` and the same body as
/// `func_actor_342400_801670C0`: in mode 0 a pending hit (`take_hit`) replaces
