...
s32 func_actor_215100_8014CDB0(Task* task, s32 arg1, GpPlaceArg* placement)
{
    GsCOORDINATE2*   coord;
    Actor160700Work* work;
    u16              yaw;
...
s32 func_actor_215100_8014CE30(Task* task, s32 arg1, GpPlaceArg* target)
{
    GsCOORDINATE2*   coord;
    Actor160700Work* work;
    s32              dx;
