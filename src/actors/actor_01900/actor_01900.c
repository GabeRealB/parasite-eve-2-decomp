...
/// 0x1C-byte scratch from `G_SCRATCH_HEAD` used by `Actor01900_Fn016F0`: `local`
...
typedef struct Actor01900SightScratch {
    /* 0x00 */ SVECTOR out;
    /* 0x08 */ SVECTOR from;
    /* 0x10 */ SVECTOR local;
    /* 0x18 */ s32     hit;
} Actor01900SightScratch;
STATIC_ASSERT_SIZEOF(Actor01900SightScratch, 0x1C);
