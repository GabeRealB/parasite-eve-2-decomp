        ...
        switch ((u16)(work->rec49C[i].field_4 >> 16)) {
            ...
            case 2:
                ...
                if (work->rec49C[i].field_4 & 0x8000) {
                    ...
                    d->vx = Wip_SysConfig.field_4->t[0] - coord->field_0.coord.t[0];
                    d->vy = Wip_SysConfig.field_4->t[1] - coord->field_0.coord.t[1];
                    d->vz = Wip_SysConfig.field_4->t[2] - coord->field_0.coord.t[2];
