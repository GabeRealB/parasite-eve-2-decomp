        ...
        case 0:
            for (i = 0; i < work->field_6FA; i++) {
                switch (work->field_6B4[i].field_0) {
                    case 0:
                        sc->out.vx = work->field_6B4[i].field_4 - Wip_SysConfig.field_4->t[0];
                        sc->out.vz = work->field_6B4[i].field_6 - Wip_SysConfig.field_4->t[2];
                    ...
                    case 1:
                        if (work->field_6B4[i].field_8 < Wip_SysConfig.field_4->t[0] &&
                            ...
                            Wip_SysConfig.field_4->t[2] < work->field_6B4[i].field_A &&
