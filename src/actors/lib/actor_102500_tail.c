...
void Actor02500_Fn0184C(Actor02500* arg0)
{
    ...
    if (effect1 != NULL) {
        sessionKey1 = (Actor02500AreaKey*)&gGameSession->loc.view;
    ...
    if (effect2 != NULL) {
        sessionKey2 = (Actor02500AreaKey*)&gGameSession->loc.view;
    ...
    if (effect3 != NULL) {
        sessionKey3 = (Actor02500AreaKey*)&gGameSession->loc.view;
