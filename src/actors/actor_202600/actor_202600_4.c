...
void func_actor_202600_8014CE1C(GpEnemy* ctx, Task* actor)
{
    ...
    work->field_214.field_18 = 0x3001A;
    ...
    work->field_2E4.field_8  = ((Actor202600Obj2C*)actor->extra)->field_8 + 4;
    rec2                     = work->field_304;
    ...
    work->field_31C.field_8  = ((Actor202600Obj2C*)actor->extra)->field_8 + 4;
    rec3                     = work->field_33C;
