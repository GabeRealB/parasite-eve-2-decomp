    ...
    switch (state) {
        ...
        case 2:
            ...
            if (work->field_3C2 == 0) {
                ...
                SndEvt_EnqueueType6(indexOrSound, pan1, (s8)Gp_GetObjDepth((GpObj38*)coord));
            }
            break;
        case 3:
            if ((s16)work->field_396 == 0x1E) {
                ...
                SndEvt_EnqueueType6(indexOrSound, pan2, (s8)Gp_GetObjDepth((GpObj38*)coord));
            }
            indexOrSound = 0;
            ...
            if ((s16)work->field_396 == 0x28) {
                ...
                SndEvt_EnqueueType6(indexOrSound, pan3, (s8)Gp_GetObjDepth((GpObj38*)coord));
                work->field_3A8        = 0x80;
                work->field_294.flags |= 0x8000;
                work->field_214.flags |= 0x4000;
            }
