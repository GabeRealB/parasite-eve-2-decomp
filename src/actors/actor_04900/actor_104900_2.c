...
extern TaskDesc  Actor04900_D155E0[];
...
extern u8                        Actor04900_D0D8F4;
extern u8                        Actor04900_D0E4DC;
extern ActorsShared801385e0Scale Actor04900_D000CC;

void Actor04900_Fn05678(GpEnemy*, Task*, ActorsShared80138efcWork*, ActorsShared80138efcArg*);
...
void Actor04900_Fn04410(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, ActorsShared80138efcArg* arg)
{
    SVECTOR        local;
    SVECTOR*       vec;
...
/// would sit inside `_2`, ahead of the rest of this unit, and insert a new
/// overlay-local run that renames `_3`..`_6`.
void Actor04900_Fn048C8(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, ActorsShared80138efcArg* arg)
{
    SVECTOR        local;
    SVECTOR*       vec;
    GsCOORDINATE2* actorCoords;
...
/// `Actor04900_D155E0`. Placement `field_BBB` 0x31 is a pair of shots;
/// otherwise one fan of three, each at ±0x12C on model part 4, with cue
/// `0x400B000A`. A set `field_BA9` stages state 0xE.
void Actor04900_Fn04DB4(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, Actor104900ShotArg* arg)
{
    SVECTOR        local;
    GsCOORDINATE2* self;
    GsCOORDINATE2* other;
            ...
            do {
                ...
                if (nInner != 0) {
                    do {
                        ...
                        arg->offset.vy = 0;
                        arg->offset.vz = 0;
                        spawned        = Task_SpawnFromTable(&Actor04900_D155E0, kind, yaw, 0);
                        if (spawned != NULL) {
...
/// would sit inside `_2`, ahead of `Actor04900_Fn05678`, and insert a
/// new overlay-local run that renames `_3`..`_6`.
void Actor04900_Fn0516C(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, ActorsShared80138efcArg* arg)
{
    GsCOORDINATE2*              actorCoords;
...
/// reaches this overlay's own `Actor04900_Fn05678`, so the body cannot
/// move into `src/actors/lib/`.
void Actor04900_Fn05CFC(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, ActorsShared80138efcArg* arg)
{
    u16 time;
...
void Actor04900_Fn05E68(Task* task)
{
    ...
    *(s32*)&mtx->m[2][0] = 0;
    ...
    obj->pos.vz    = 0;
    obj->radius    = 0;
    obj->key       = Gp_PackPair(&Actor04900_D074D0[0], 5);
    obj->flags     = 3;
