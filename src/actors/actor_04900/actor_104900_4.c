...
void Actor04900_Fn06C0C(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, void* scratch)
{
    GpLinkXform* xform;
    s32          off;
    s32          i;
    ...
    xform->src.vy     = -0xC8;
    xform->src.vz     = 0xC8;
    if ((Actor04900_Fn00F58(enemy, task, work, scratch) == 0) && (task->spawnArg1 == 0)) {
...
///
/// Either way the link transform is re-armed exactly as `Actor04900_Fn06C0C`
...
/// runs last.
void Actor04900_Fn06D3C(GpEnemy* enemy, Task* task, ActorsShared80138efcWork* work, void* scratch)
{
    GpLinkXform* xform;
    s16          walk;
    ...
    xform->src.vy = -0xC8;
    xform->src.vz = 0xC8;
    Actor04900_Fn00F58(enemy, task, work, scratch);
}
