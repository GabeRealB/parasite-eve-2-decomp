...
{
    if (arg0->state == 0) {
        D_80114DCC = *(u32*)&gGameSession->field_4 & 0xFFFF0000;
    }
    switch (D_80114DCC) {
        case 0x1010000:
            func_8017F41C(arg0);
...
void Gp_MapTaskState2(Task* arg0)
{
    ...
    obj   = arg0->spawnArg2;
    flags = Gp_MapFlagIds[gGameSession->field_7 - 1];
    ...
    if (obj->status == 1) {
        if (Pad_CheckButtons(0, 1, Pad_MaskCancel | 0x100) != 0) {
            ...
            func_800D1F90(arg0);
            obj->field_2E = 6;
            if ((*(u32*)&gGameSession->field_4 & 0xFFFF0000) == 0x04280000) {
                Gp_LoadViewAndCd(1);
            }
            arg0->state = 3;
            return;
        ...
        if (Pad_CheckButtons(0, 1, 0x2000) != 0) {
            ...
            for (room = Gp_MapRoomId + 1; room <= D_8010F130[gGameSession->field_7 - 1]; room++) {
...
void Gp_DrawMapCursor(Task* arg0)
{
    ...
    rec   = Gp_MapRecTables[gGameSession->field_7 - 1];
    rec   = rec + gGameSession->field_6;
...
void Gp_DrawMapMarks(Task* arg0)
{
    ...
    if (Gp_MapMarkCounts[session->field_7 - 1] != 0) {
        ...
        do {
            ...
            i++;
        } while ((u8)i < Gp_MapMarkCounts[gGameSession->field_7 - 1]);
    }
}
...
s32 Gp_DrawMapIcons(Task* arg0, u8 arg1, u8 arg2)
{
    ...
    ret     = 0;
    obj     = arg0->spawnArg2;
    icons   = D_8010F0CC[gGameSession->field_7 - 1];
...
void Gp_EnqueueMapRoomCd(void)
{
    ...
    if ((gGameSession->field_7 == 4) && ((s8)Gp_MapRoomId == 6) && (GameFlag_GetNibble(0xB7) == 0)) {
        Gp_MapRoomOff = 1;
    }
    if (gGameSession->field_7 == 5) {
...
s8 func_800D1434(u32 roomId, u8 flagId)
{
    ...
    bank = Gp_FlagBanks[gGameSession->field_7];
    if (gGameSession->field_7 != 5) {
        if (flagId != 0xFF) {
            if (flagId == 0x80) {
                return 0;
            ...
            recs     = Gp_MapRecTables[gGameSession->field_7 - 1];
            flags[0] = bank->field_4[0];
            flags[1] = bank->field_4[1];
            i        = 0;
...
void func_800D15D0(Task* arg0)
{
    ...
    i = Gp_MapRoomId + 1;
    while ((u8)i <= D_8010F130[gGameSession->field_7 - 1]) {
        if (flagIds[(u8)i] == 0) {
            return;
        }
        if (flagIds[(u8)i] == 0xFF) {
